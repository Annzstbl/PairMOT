...
def load_multiple_tracker_summaries(tracker_folder, tracker_list, cls):
    ...
    for tracker in tracker_list:
        csv_path = os.path.join(tracker_folder, tracker, cls + '_summary.csv')
        txt_path = os.path.join(tracker_folder, tracker, cls + '_summary.txt')
        summary_path = csv_path if os.path.isfile(csv_path) else txt_path
