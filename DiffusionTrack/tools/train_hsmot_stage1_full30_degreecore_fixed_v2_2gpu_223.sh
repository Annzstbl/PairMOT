#!/usr/bin/env bash
# Manual two-GPU fresh run after the complete degree-geometry repair.
set -euo pipefail
...
EXP=yolo11l_diffusion_det_hsmot_full30_degreecore_fixed_v2
...
exec "${ENV}/bin/python" tools/train.py \
    -f exps/example/mot/yolo11l_diffusion_det_hsmot_full30_degreecore_fixed_v2.py \
