...
EXP_NAME=yolo11l_diffusion_det_hsmot_overfit_data43_2_legacycenter_covered_lxlr_b2_acc1_100e_gpu0_v3
LOG=${RUNTIME}/logs/stage1_overfit_data43_2_legacycenter_covered_lxlr_b2_acc1_100e_gpu0_v3_20260724.log
...
exec "${ENV}/bin/python" tools/train.py \
    -f exps/example/mot/yolo11l_diffusion_det_hsmot_overfit_legacy_penalty_covered.py \
    -d 1 -b 2 --accumulate 1 --amp-dtype bf16 \
