...
EXP_NAME=yolo11l_diffusion_det_hsmot_overfit_data43_2_legacycenter_uncovered_lxlr_b1_acc1_100e_gpu0_v1
LOG=${RUNTIME}/logs/stage1_overfit_data43_2_legacycenter_uncovered_lxlr_b1_acc1_100e_gpu0_v1_20260723.log
...
exec "${ENV}/bin/python" tools/train.py \
    -f exps/example/mot/yolo11l_diffusion_det_hsmot_overfit_legacy_penalty_uncovered.py \
