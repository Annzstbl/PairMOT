...
EXP_NAME=yolo11l_diffusion_det_hsmot_overfit_data43_2_formal_randomt_l1fix_nocenter_projxy_featurevis_200e_nockpt_gpu2_v6
LOG=${RUNTIME}/logs/stage1_overfit_data43_2_formal_randomt_l1fix_nocenter_projxy_featurevis_200e_nockpt_gpu2_v6_20260723.log
...
exec "${ENV}/bin/python" tools/train.py \
    -f exps/example/mot/yolo11l_diffusion_det_hsmot_overfit_formal_randomt.py \
