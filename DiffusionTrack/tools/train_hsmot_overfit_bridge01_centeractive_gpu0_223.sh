...
EXP_NAME=yolo11l_diffusion_det_hsmot_overfit_bridge01_centeractive_b1_acc1_100e_gpu0_v1
LOG=${RUNTIME}/logs/stage1_overfit_bridge01_centeractive_b1_acc1_100e_gpu0_v1_20260724.log
...
exec "${ENV}/bin/python" tools/train.py \
    -f exps/example/mot/yolo11l_diffusion_det_hsmot_overfit_bridge01_centeractive.py \
