...
@pytest.mark.parametrize(
    "x1, x2, aligned, expected",
    [
        (
            torch.tensor([[0.5, 0.5, 1.0, 1.0, 0.25], [0.0, 0.0, 0.5, 0.5, 0.75]]),
            torch.tensor([[0.0, 0.0, 1.0, 1.0, 0.5], [0.1, 0.1, 0.5, 0.5, 0.2]]),
            True,
        ...
        (
            ...
            torch.tensor([[0.0, 0.0, 1.0, 1.0, 0.5], [0.1, 0.1, 0.5, 0.5, 0.2]]),
            False,
            torch.tensor([[1.25, 1.85], [1.25, 0.75]]),
        ),
    ],
)
