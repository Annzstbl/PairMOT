"""1-epoch test config on real HSMOT subset (3jpg, mini splits)."""
from mmengine.config import read_base

with read_base():
    from .o2_rtdetr_r18vd_2xb4_72e_hsmot import *
    from .hsmot_test import *

model.num_queries = 100
model.backbone.init_cfg = None
model.backbone.frozen_stages = 4
model.backbone.norm_eval = True
model.dn_cfg.group_cfg.num_dn_queries = 30
...
work_dir = 'work_dirs/o2_rtdetr_r18vd_1xb1_1e_hsmot_test'
