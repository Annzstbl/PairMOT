"""0731_08: shared attention plus classification-only bounded detail.

Attention aggregation weights are shared across frames while sampling,
value, and output projections remain independent.  Bounded swap-odd detail
is exposed only to the two classification heads; regression and iterative
references stay on the shared decoder state.
"""
...
work_dir = (
    ...
    '0731_08_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_sharedattention_classificationenvelopeddetail_'
