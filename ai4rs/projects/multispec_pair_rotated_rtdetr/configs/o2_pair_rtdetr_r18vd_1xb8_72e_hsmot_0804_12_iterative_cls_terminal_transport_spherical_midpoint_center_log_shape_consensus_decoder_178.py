"""0804_12 on 178: spherical-midpoint center with log-shape consensus.

This is the single-GPU, physical-batch-8 equivalent of the 99 two-GPU
candidate. Relative to mature terminal log-size/periodic-angle consensus, the
only new factor moves antisymmetric center-detail direction to the spherical
...
with read_base():
    from .o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_13_iterative_cls_terminal_log_size_periodic_angle_decoder_178 import *  # noqa: F401,F403
