"""0731_09: dual-card replication of regression-only frame detail.

This is the 2xb4 counterpart of 178/0731_06. Classification remains on the
shared-attention decoder state; only iterative box refinement receives the
zero-start, bounded, swap-odd frame correction.
"""
...
work_dir = (
    ...
    '0731_09_paper_base_liquid_encoder_p5temporal_dualevidence_'
