"""0731_20: shared attention plus classification-only common evidence.

This isolates the classification component of 0731_18. Final classification
receives common evidence, while every box and recurrent reference stays on the
shared-attention parent path.
"""
...
work_dir = (
    ...
    '0731_20_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_sharedattention_terminalclassificationcommonevidence_'
