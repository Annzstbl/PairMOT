"""0803_23: terminal transported full-tangent geometric consensus.

Only the final normal-query box update is paired. Pair-common refinement is
kept in the natural box tangent, while frame detail is retained only along
the relative transform already accumulated by earlier decoder layers. DN and
earlier recurrent references remain frame-specific. The projection adds no
parameters, layers, attention, class-aware logic, reweighting, or loss.
"""
...
work_dir = (
    ...
    '0803_23_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_iterativeclsdnisolatede2e_pairsharedterminaltransporttangent_'
