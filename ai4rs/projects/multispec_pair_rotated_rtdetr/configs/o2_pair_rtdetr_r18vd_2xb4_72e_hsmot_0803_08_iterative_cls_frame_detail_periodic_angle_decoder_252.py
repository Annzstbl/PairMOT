"""0803_08 DDP: common-preserving frame detail plus periodic angle.

Each classification input keeps the shared decoder output as the exact pair
midpoint and receives half of the swap-odd difference between the existing
prev/curr cross-attention observations. Regression, references, recurrent
queries, DN, losses, attention count, and decoder depth stay on the parent
