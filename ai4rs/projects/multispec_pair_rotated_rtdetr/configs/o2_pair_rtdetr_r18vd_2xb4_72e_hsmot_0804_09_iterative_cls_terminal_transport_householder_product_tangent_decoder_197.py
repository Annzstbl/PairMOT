"""0804_09 on 197: norm-preserving Householder product transport.

This single-factor successor to the product tangent replaces each rank-one
detail projection with a minimal orthogonal Householder transport onto the
established center or shape motion axis.  It preserves the complete detail
norm while retaining factorized center/shape geometry.  The operation is
zero-state, swap-equivariant, class agnostic, and uses no prediction
reweighting, new layer, attention, or loss.
"""
from mmengine.config import read_base

with read_base():
    from .o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0804_06_iterative_cls_terminal_transport_frenet_product_tangent_decoder_197 import *  # noqa: F401,F403
...
work_dir = (
    ...
    '0804_09_paper_base_liquid_encoder_p5temporal_dualevidence_'
