"""0731_02: bounded frame-detail correction on the 0727_01 parent.

The recurrent decoder query remains the parent path.  Only the frame-local
head states receive a zero-start, swap-odd correction whose elementwise
magnitude is bounded by the observed raw cross-attention frame difference.
"""
...
work_dir = (
    ...
    '0731_02_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_envelopeddetail_pairdn_paircoherent_le180_r18_'
