"""0721_04: accuracy-fixed 0718_01 with band-slot calibration."""
...
_sampler['band_slot_calibration'] = dict(max_relative_delta=1.0)
optim_wrapper['paramwise_cfg']['custom_keys'][
    'backbone.stem.0.band_slot_calibration'] = dict(lr_mult=1.0)
...
work_dir = (
    ...
    '0721_04_paper_liquid_bsac_diffproduct_accuracyfix_r18_coco_full_'
