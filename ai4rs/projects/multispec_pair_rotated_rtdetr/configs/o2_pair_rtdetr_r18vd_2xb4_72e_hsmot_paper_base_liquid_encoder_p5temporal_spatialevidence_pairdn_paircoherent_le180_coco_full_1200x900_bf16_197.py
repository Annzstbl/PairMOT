"""0727_02: spatially selective dual-evidence temporal encoder.

This is the spatial-evidence successor of 0727_01. A lightweight two-channel
local gate uses common-feature magnitude and frame-detail magnitude to keep
P3/P4/P5 temporal updates focused on reliable object evidence. All Liquid and
training semantics remain identical to 0723_01.
"""
...
work_dir = (
    ...
    '0727_02_paper_base_liquid_encoder_p5temporal_spatialevidence_'
