"""0803_19: terminal full-tangent geometric consensus.

Only the final reported normal-query box update is paired. Center displacement
is averaged in reference-local coordinates, size in log-ratio coordinates,
and orientation in the pi-periodic tangent space. Earlier recurrent references
and DN remain frame-specific. The projection adds no parameters, layers,
attention, class-aware logic, reweighting, or loss.
"""
...
work_dir = (
    ...
    '0803_19_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_iterativeclsdnisolatede2e_pairsharedterminalfulltangent_'
