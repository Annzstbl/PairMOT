"""0731_12: shared attention plus terminal-only frame detail.
...
the final per-frame classification and regression outputs.  This tests
whether useful frame detail can be retained without recursively perturbing
the decoder state.
"""
