"""0731_19: terminal classification-only common evidence.

The final classification branches receive a shared, swap-invariant correction.
Box regression, auxiliary predictions, and recurrent references remain exactly
on the 0727_01 parent path.
"""
...
work_dir = (
    ...
    '0731_19_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_terminalclassificationcommonevidence_pairdn_paircoherent_'
