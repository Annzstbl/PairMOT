"""0803_09: log-size tangent consensus plus periodic angle consensus.

Normal-query width/height refinement is shared as a multiplicative increment
relative to each frame's own reference, while orientation uses the pi-periodic
...
work_dir = (
    ...
    '0803_09_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_iterativeclsdnisolatede2e_pairsharedlogsizetangent_'
