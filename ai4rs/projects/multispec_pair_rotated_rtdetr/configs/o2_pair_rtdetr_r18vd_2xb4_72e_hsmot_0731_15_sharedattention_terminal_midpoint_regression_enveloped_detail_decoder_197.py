"""0731_15: terminal midpoint-preserving regression-only frame detail.

Classification, auxiliary predictions, and recurrent references remain on
the shared-attention parent path.  The terminal box correction is a strictly
antisymmetric 5D logit residual, preserving the added pair midpoint while
retaining frame-localized geometry.
"""
...
work_dir = (
    ...
    '0731_15_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_sharedattention_terminalmidpointregressionenvelopeddetail_'
