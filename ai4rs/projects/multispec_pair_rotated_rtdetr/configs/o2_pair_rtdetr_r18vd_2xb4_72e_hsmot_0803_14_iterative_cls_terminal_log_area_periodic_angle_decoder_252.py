"""0803_14: terminal-only log-area and periodic-angle consensus.

The recurrent decoder remains frame-specific.  Only the final output shares
the isotropic log-area increment and periodic angle while preserving each
frame's aspect-ratio correction.  The design is parameter-free, class
agnostic, and adds no layer, attention, or loss reweighting.
"""
...
model['decoder'].update(
    ...
    pair_shared_terminal_log_area_periodic_angle_refinement_decoder=True,
