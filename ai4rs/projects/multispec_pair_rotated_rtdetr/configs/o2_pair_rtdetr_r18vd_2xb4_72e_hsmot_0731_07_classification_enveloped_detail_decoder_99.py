"""0731_07: classification-only bounded frame detail.

The recurrent decoder query, both regression heads, and iterative references
remain exactly on the 0727_01 parent path.  Only the frame-specific
classification states receive a zero-start, swap-odd correction bounded by
the observed cross-attention frame difference.
"""
...
work_dir = (
    ...
    '0731_07_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_classificationenvelopeddetail_pairdn_paircoherent_le180_r18_'
