"""0803_13: terminal-only log-size and periodic-angle consensus.

All recurrent decoder references remain frame-specific.  Only the final
reported box update shares multiplicative width/height increments and the
pi-periodic angle increment.  This isolates output consistency from decoder
state propagation while adding no parameters, layers, attention, class-aware
logic, or loss reweighting.
"""
