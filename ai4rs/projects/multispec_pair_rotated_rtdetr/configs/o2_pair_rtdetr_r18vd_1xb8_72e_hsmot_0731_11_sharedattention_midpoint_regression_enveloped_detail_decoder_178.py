"""0731_11: midpoint-preserving regression-only detail on 178.

Classification remains on the shared-attention decoder state. Frame evidence
becomes an exactly antisymmetric correction in 5D box-logit residual space,
so the added detail cannot shift the pair midpoint.
"""
...
work_dir = (
    ...
    '0731_11_paper_base_liquid_encoder_p5temporal_dualevidence_'
