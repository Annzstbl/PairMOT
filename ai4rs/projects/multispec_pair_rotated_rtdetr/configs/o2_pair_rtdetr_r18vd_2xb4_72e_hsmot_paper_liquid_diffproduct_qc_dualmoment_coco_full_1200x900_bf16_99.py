"""0720_03: 0718_01 Liquid with dual-moment fusion conservation."""
...
model['backbone']['liquid_sampler']['liquid_aware_fusion'][
    'quality_conservation'] = dict(mode='dual_moment')
...
work_dir = (
    ...
    '0720_03_paper_liquid_diffproduct_qc_dualmoment_r18_coco_full_1200x900_bf16_orderedpairs_fresh')
