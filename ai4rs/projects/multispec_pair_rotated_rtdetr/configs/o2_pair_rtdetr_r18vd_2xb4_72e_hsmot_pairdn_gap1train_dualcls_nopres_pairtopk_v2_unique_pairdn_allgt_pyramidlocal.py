"""0705_02: 0704_01 + post-FPN pyramid-local temporal adapter only.

This is the ablation for 0705_01.  It keeps the same all-GT unique proposal
baseline and the same pretrain chain, but removes the P5 global MHA temporal
adapter.  The only added temporal interaction is the zero-gated multi-scale
local adapter after FPN/CCFF, so the initial forward path is still equivalent
to 0704_01.
"""
...
work_dir = (
    ...
    '0705_02_o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_half_pairdn_'
