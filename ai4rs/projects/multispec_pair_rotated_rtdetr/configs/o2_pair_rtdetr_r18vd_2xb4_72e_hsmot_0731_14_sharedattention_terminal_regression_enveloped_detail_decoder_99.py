"""0731_14: terminal-only regression detail with shared classification.

The shared-attention decoder, all auxiliary outputs, and recurrent references
stay on the parent path.  Only the terminal frame boxes receive bounded
swap-odd detail.  Classification features remain exactly shared so frame
detail cannot alter score-based matching or filtering.
"""
...
model['decoder'].update(
    ...
    terminal_regression_enveloped_detail_decoder=True,
    terminal_midpoint_regression_enveloped_detail_decoder=False,
    common_evidence_bypass_decoder=False)

work_dir = (
    '/data4/litianhao/PairMmot/workdir_99/'
    '0731_14_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_sharedattention_terminalregressionenvelopeddetail_'
