"""Four-iteration two-GPU real-data smoke for 0731_22."""
from mmengine.config import read_base

with read_base():
    from ..o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0731_22_terminal_detached_classification_common_evidence_decoder_99 import *  # noqa: F401,F403
...
work_dir = ('/data4/litianhao/PairMmot/workdir_99/'
            'smoke_0731_22_terminal_detached_classification_'
            'common_evidence_decoder_4iter')
