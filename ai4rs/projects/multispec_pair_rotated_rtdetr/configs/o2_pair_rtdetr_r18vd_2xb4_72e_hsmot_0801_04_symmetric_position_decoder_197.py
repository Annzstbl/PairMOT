"""0801_04: position-only symmetric pair decoder.

Only the shared decoder query position is made invariant to frame order. The
two deformable cross-attention modules and ordered frame-feature fusion retain
their full frame-specific capacity. Repeating the mean position through the
existing fusion layer adds no parameters, matrix multiplications, branches,
losses, or decoder depth.
"""
...
work_dir = (
    ...
    '0801_04_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_symmetricposition_pairdn_paircoherent_le180_r18_'
