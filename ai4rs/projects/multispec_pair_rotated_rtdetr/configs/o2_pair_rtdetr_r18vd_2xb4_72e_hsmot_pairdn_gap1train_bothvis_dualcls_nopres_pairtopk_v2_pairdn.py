"""Gap-1 both-visible dual-cls/no-presence PairDN with pair-topk-v2."""
from mmengine.config import read_base

with read_base():
    from .o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_pairdn_gap1train_bothvis_dualcls_nopres_pairdn import *  # noqa: F401,F403
...
work_dir = (
    ...
    'gap1train_bothvis_dualcls_nopres_pairtopk_v2_pairdn')
