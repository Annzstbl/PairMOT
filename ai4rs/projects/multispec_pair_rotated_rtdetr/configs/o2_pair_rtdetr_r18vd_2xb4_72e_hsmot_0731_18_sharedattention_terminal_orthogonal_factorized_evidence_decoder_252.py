"""0731_18: strictly orthogonal terminal evidence on the 0727_01 parent.

Only final classification receives the shared, swap-invariant common-evidence
correction. Box regression keeps the unmodified parent representation and
receives only a strictly antisymmetric 5D residual from bounded frame detail.
Auxiliary outputs and recurrent references remain on the parent path.
"""
...
work_dir = (
    ...
    '0731_18_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_sharedattention_terminalorthogonalfactorizedevidence_'
