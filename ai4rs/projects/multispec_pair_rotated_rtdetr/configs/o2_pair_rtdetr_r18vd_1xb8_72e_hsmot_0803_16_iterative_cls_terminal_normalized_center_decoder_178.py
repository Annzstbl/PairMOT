"""0803_16: terminal-only reference-local center consensus.

All recurrent references stay frame-specific. Only the final reported center
increment is shared in each reference box's local width/height coordinates.
Size, angle, classification, and DN remain independent. The projection is
parameter-free, class agnostic, and adds no attention, layer, or reweighting.
"""
...
work_dir = (
    ...
    '0803_16_paper_base_liquid_encoder_p5temporal_dualevidence_'
    'decoder_iterativeclsdnisolatede2e_pairsharedterminalnormalizedcenter_'
    'refinement_pairdn_paircoherent_le180_'
