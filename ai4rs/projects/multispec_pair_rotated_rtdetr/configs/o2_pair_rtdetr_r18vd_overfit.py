"""Pair RT-DETR overfit config: fixed mini pairs, weak aug, thousands of iters."""
...
with read_base():
    ...
    from .hsmot_pair_overfit import *
...
# Start from HSMOT single-frame O2 (3dse_reduction2, epoch 72); adapted for pair in
# ``run_hsmot_pair_overfit_acceptance.run_training``.
...
# Match ``o2_rtdetr_r18vd_2xb4_72e_hsmot_coco_pretrain_3dse_reduction2``.
...
# Base DETR merges ``model.train_cfg`` into bbox_head at build time.
...
work_dir = 'work_dirs/o2_pair_rtdetr_r18vd_overfit'
