"""Build 0803_08 and prove both routes add no model state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_08_iterative_cls_'
    'frame_detail_periodic_angle_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_08_iterative_cls_frame_detail_'
...
parent_config.model.decoder.frame_detail_cls_decoder = False
...
assert new_config.model.decoder.frame_detail_cls_decoder
...
print('ITERATIVE_CLS_FRAME_DETAIL_PERIODIC_ANGLE_BUILD_OK', {
