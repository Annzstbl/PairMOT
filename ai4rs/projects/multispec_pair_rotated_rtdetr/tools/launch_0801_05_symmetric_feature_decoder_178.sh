...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0801_05_symmetric_feature_decoder_178.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/0801_05_paper_base_liquid_encoder_p5temporal_dualevidence_decoder_symmetricfeature_pairdn_paircoherent_le180_r18_coco_full_1200x900_bf16_1xb8_fresh
...
echo "[$(date '+%F %T')] fresh formal 0801_05 commit $(git rev-parse --short HEAD)" \
    >> "${WORK_DIR}/launch.log"
