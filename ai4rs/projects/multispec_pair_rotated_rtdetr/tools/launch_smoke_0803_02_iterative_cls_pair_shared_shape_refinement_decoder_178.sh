...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0803_02_iterative_cls_pair_shared_shape_refinement_decoder_4iter_smoke_178.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/smoke_0803_02_iterative_cls_pair_shared_shape_refinement_decoder_4iter
...
echo "[$(date '+%F %T')] fresh 0803_02 real-data smoke commit $(git rev-parse --short HEAD)" \
    >> "${WORK_DIR}/launch.log"
