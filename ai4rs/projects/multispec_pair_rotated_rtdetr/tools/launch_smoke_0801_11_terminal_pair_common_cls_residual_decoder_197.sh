...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0801_11_terminal_pair_common_cls_residual_decoder_4iter_smoke_197.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_197/smoke_0801_11_terminal_pair_common_cls_residual_decoder_4iter
...
echo "[$(date '+%F %T')] fresh 0801_11 real-data DDP smoke commit $(git rev-parse --short HEAD)" \
    >> "${WORK_DIR}/launch.log"
"${PYTHON_ROOT}/torchrun" --nproc_per_node=2 --master_port=29986 \
