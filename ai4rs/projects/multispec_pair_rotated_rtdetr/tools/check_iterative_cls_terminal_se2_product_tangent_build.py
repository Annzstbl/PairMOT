"""Build 0804_05 and prove SE(2) product tangent adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0804_05_iterative_cls_terminal_'
    'transport_se2_product_tangent_decoder_99.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_05_iterative_cls_terminal_transport_se2_'
    'product_tangent_decoder_4iter_smoke_99.py')
...
assert decoder.pair_shared_terminal_transport_se2_product_tangent_refinement_decoder
...
print('ITERATIVE_CLS_TERMINAL_SE2_PRODUCT_TANGENT_BUILD_OK', {
