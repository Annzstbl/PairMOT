"""Build 0803_30 and prove geometry-only tangent plane adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_30_iterative_cls_'
    'terminal_transport_plane_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_30_iterative_cls_terminal_transport_'
    'plane_decoder_4iter_smoke_178.py')
...
assert decoder.pair_shared_terminal_transport_plane_refinement_decoder
assert not decoder.pair_shared_terminal_transport_tangent_refinement_decoder
assert not decoder.get('terminal_position_tangent_plane_decoder', False)
assert not decoder.get('terminal_position_tangent_transport_decoder', False)
assert not decoder.get('terminal_position_tangent_product_decoder', False)
...
print('ITERATIVE_CLS_TERMINAL_TRANSPORT_PLANE_BUILD_OK', {
