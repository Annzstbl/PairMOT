"""Build 0803_15 and prove terminal angle consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_15_iterative_cls_'
    'terminal_periodic_angle_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_15_iterative_cls_terminal_periodic_'
    'angle_decoder_4iter_smoke_178.py')
...
parent_config.model.decoder.pair_shared_terminal_periodic_angle_refinement_decoder = False

assert new_config.model.decoder.pair_shared_terminal_periodic_angle_refinement_decoder
...
print('ITERATIVE_CLS_TERMINAL_PERIODIC_ANGLE_BUILD_OK', {
