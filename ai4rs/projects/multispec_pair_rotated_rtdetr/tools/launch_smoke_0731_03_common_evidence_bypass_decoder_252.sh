...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0731_03_common_evidence_bypass_decoder_4iter_smoke_252.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_252/smoke_0731_03_common_evidence_bypass_decoder_4iter
...
echo "[$(date '+%F %T')] fresh 0731_03 real-data DDP smoke" \
    >> "${WORK_DIR}/launch.log"
"${PYTHON_ROOT}/torchrun" --nproc_per_node=2 --master_port=29563 \
...
"${PYTHON_ROOT}/python" \
    projects/multispec_pair_rotated_rtdetr/tools/check_common_evidence_bypass_checkpoint.py \
