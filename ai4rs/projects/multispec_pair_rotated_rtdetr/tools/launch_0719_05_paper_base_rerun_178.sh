...
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/0719_05_paper_base_rerun_r18_coco_full_1200x900_bf16_1xb8
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_paper_base_rerun_coco_full_1200x900_bf16_178.py
...
echo "[$(date '+%F %T')] fresh paper Base rerun on GPU ${CUDA_VISIBLE_DEVICES}, bs=8, workers=8" >> "${LOG}"
