"""Build 0804_11 and prove the center/log-shape hybrid adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0804_11_iterative_cls_terminal_'
    'transport_center_tangent_log_shape_consensus_decoder_99.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_11_iterative_cls_terminal_transport_center_'
    'tangent_log_shape_consensus_decoder_4iter_smoke_99.py')
...
assert decoder.pair_shared_terminal_transport_center_tangent_log_shape_consensus_refinement_decoder
for flag in (
...
print('ITERATIVE_CLS_TERMINAL_CENTER_TANGENT_LOG_SHAPE_CONSENSUS_BUILD_OK', {
