...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0808_06_iterative_cls_terminal_transport_product_tangent_delayedlrclock_decoder_99.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_99/0808_06_final_product_tangent_delayedlrclock_72e_2xb4_fresh
...
echo "[$(date '+%F %T')] fresh formal 0808_06 GPUs=${CUDA_VISIBLE_DEVICES} commit $(git rev-parse --short HEAD)" >> "${WORK_DIR}/launch.log"
