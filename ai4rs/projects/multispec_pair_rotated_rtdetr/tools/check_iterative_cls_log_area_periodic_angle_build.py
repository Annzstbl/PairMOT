"""Build 0803_10 and prove the geometric projection adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_10_iterative_cls_'
    'log_area_periodic_angle_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_10_iterative_cls_log_area_'
...
parent_config.model.decoder.pair_shared_log_area_periodic_angle_refinement_decoder = False
...
assert new_config.model.decoder.pair_shared_log_area_periodic_angle_refinement_decoder
...
print('ITERATIVE_CLS_LOG_AREA_PERIODIC_ANGLE_BUILD_OK', {
