...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0731_29_terminal_diagonal_center_motion_factorized_evidence_decoder_252.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_252/0731_29_paper_base_liquid_encoder_p5temporal_dualevidence_decoder_terminaldiagonalcentermotionfactorizedevidence_pairdn_paircoherent_le180_r18_coco_full_1200x900_bf16_2xb4_fresh
...
echo "[$(date '+%F %T')] fresh formal 0731_29 commit $(git rev-parse --short HEAD)" >> "${WORK_DIR}/launch.log"
