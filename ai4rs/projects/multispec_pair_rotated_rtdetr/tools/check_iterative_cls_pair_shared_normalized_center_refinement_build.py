"""Build 0803_05 and prove that its center projection adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0803_05_iterative_cls_pair_'
    'shared_normalized_center_refinement_decoder_252.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_05_iterative_cls_pair_shared_normalized_'
    'center_refinement_decoder_4iter_smoke_252.py')
...
parent_config.model.decoder.pair_shared_normalized_center_refinement_decoder = (
    False)

assert new_config.model.decoder.pair_shared_normalized_center_refinement_decoder
...
print('ITERATIVE_CLS_PAIR_SHARED_NORMALIZED_CENTER_REFINEMENT_BUILD_OK', {
