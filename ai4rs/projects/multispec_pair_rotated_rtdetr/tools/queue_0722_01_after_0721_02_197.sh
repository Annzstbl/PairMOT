...
LAUNCHER=${REPO}/projects/multispec_pair_rotated_rtdetr/tools/launch_0722_01_liquid_independent_diffproduct_dnnegativefix_197.sh
PREDECESSOR_CONFIG=o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_liquid_independent_diffproduct_accuracyfix_coco_full_1200x900_bf16_197.py
PREDECESSOR_DIR=/data4/litianhao/PairMmot/workdir_197/0721_02_paper_liquid_independent_diffproduct_accuracyfix_r18_coco_full_1200x900_bf16_orderedpairs_fresh
LOCK=/data4/litianhao/PairMmot/workdir_197/.queue_0722_01.lock
SMOKE_CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_liquid_independent_diffproduct_dnnegativefix_4iter_smoke_197.py
SMOKE_DIR=/data4/litianhao/PairMmot/workdir_197/smoke_0722_01_dnnegativefix_4iter
MEMORY_LIMIT_MIB=2048

trap 'rc=$?; echo "[$(date '+"'"'%F %T'"'"')] FAILED_TO_START rc=${rc} command=${BASH_COMMAND}"; exit ${rc}' ERR
exec 9>"${LOCK}"
flock -n 9 || { echo "another 0722_01 queue is active"; exit 3; }
...
echo "[$(date '+%F %T')] smoke passed; launching formal 0722_01"
exec bash "${LAUNCHER}"
