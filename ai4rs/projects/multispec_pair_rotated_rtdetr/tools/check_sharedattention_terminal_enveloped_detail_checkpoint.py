"""Verify shared attention and the learned terminal-only detail gate."""
...
print('SHAREDATTENTION_TERMINAL_ENVELOPED_DETAIL_CHECKPOINT_OK', {
    ...
    'terminal_enveloped_detail_maxima': maxima,
})
