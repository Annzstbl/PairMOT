...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0801_08_iterative_cls_dn_isolated_decoder_4iter_smoke_99.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_99/smoke_0801_08_iterative_cls_dn_isolated_decoder_4iter_retry1
...
echo "[$(date '+%F %T')] fresh 0801_08 real-data DDP smoke" \
    >> "${WORK_DIR}/launch.log"
"${PYTHON_ROOT}/torchrun" --nproc_per_node=2 --master_port=29818 \
