"""Build 0803_29 and prove tangent-plane transport adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0803_29_iterative_cls_'
    'terminal_position_tangent_plane_decoder_99.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_29_iterative_cls_terminal_position_'
    'tangent_plane_decoder_4iter_smoke_99.py')
...
assert decoder.terminal_position_tangent_plane_decoder
...
print('ITERATIVE_CLS_TERMINAL_POSITION_TANGENT_PLANE_BUILD_OK', {
