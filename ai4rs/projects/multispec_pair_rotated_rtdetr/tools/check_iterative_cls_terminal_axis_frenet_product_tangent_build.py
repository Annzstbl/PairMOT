"""Build 0804_07 and prove axis-Frenet product tangent adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0804_07_iterative_cls_terminal_'
    'transport_axis_frenet_product_tangent_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_07_iterative_cls_terminal_transport_axis_'
    'frenet_product_tangent_decoder_4iter_smoke_178.py')
...
print('ITERATIVE_CLS_TERMINAL_AXIS_FRENET_PRODUCT_TANGENT_BUILD_OK', {
