"""Build 0806_07 and prove the stratified fallback adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0806_07_iterative_cls_terminal_'
    'transport_stratified_product_tangent_decoder_99.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0806_07_iterative_cls_terminal_transport_'
    'stratified_product_tangent_decoder_4iter_smoke_99.py')
...
assert decoder.pair_shared_terminal_transport_stratified_product_tangent_refinement_decoder
for flag in (
...
print('ITERATIVE_CLS_TERMINAL_STRATIFIED_PRODUCT_TANGENT_BUILD_OK', {
