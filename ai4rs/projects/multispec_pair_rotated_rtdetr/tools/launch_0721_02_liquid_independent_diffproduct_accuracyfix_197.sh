...
WORK_DIR=/data4/litianhao/PairMmot/workdir_197/0721_02_paper_liquid_independent_diffproduct_accuracyfix_r18_coco_full_1200x900_bf16_orderedpairs_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_liquid_independent_diffproduct_accuracyfix_coco_full_1200x900_bf16_197.py
...
echo "[$(date '+%F %T')] fresh 0721_02 accuracy-fixed strict 0718_01 rerun on 197 GPUs ${CUDA_VISIBLE_DEVICES}" >> "${LOG}"
