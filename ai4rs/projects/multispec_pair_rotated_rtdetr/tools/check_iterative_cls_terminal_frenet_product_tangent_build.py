"""Build 0804_06 and prove Frenet product tangent adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0804_06_iterative_cls_terminal_'
    'transport_frenet_product_tangent_decoder_197.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_06_iterative_cls_terminal_transport_frenet_'
    'product_tangent_decoder_4iter_smoke_197.py')
...
assert decoder.pair_shared_terminal_transport_frenet_product_tangent_refinement_decoder
...
print('ITERATIVE_CLS_TERMINAL_FRENET_PRODUCT_TANGENT_BUILD_OK', {
