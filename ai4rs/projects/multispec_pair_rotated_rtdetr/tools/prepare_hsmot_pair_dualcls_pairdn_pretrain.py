#!/usr/bin/env python3
"""Create the pair-adapted HSMOT R18 checkpoint for dual-cls PairDN heads."""
...
def main() -> None:
    ...
    output = ensure_pair_adapted_checkpoint(
        str(src_ckpt),
        str(root / 'o2_r18_hsmot_3dse_r2_e72_pair_dualcls_pairdn_adapted'),
        copy_cls_branches_curr=True,
        copy_dn_query_generator_to_pair=True,
        output_name='pair_dualcls_pairdn_adapted_pretrain.pth')
    print(output)
