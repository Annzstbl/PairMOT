"""Build 0803_01 and prove that its projection adds no model state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0803_01_iterative_cls_pair_'
    'shared_objectness_decoder_252.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_01_iterative_cls_pair_shared_'
    'objectness_decoder_4iter_smoke_252.py')
...
parent_config.model.bbox_head.iterative_cls_pair_shared_objectness = False
...
assert head_config.iterative_cls_pair_shared_objectness
...
print('ITERATIVE_CLS_PAIR_SHARED_OBJECTNESS_BUILD_OK', {
