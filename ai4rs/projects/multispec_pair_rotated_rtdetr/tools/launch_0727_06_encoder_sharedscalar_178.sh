...
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/0727_06_paper_base_liquid_encoder_p5temporal_sharedscalar_pairdn_paircoherent_le180_r18_coco_full_1200x900_bf16_1xb8_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_paper_base_liquid_encoder_p5temporal_sharedscalar_pairdn_paircoherent_le180_coco_full_1200x900_bf16_178.py
...
echo "[$(date '+%F %T')] fresh 0727_06 shared-scalar evidence encoder, bs=8" >> "${LOG}"
