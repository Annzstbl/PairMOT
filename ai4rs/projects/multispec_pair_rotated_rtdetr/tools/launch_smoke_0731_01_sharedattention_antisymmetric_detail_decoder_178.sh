...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0731_01_sharedattention_antisymmetric_detail_decoder_4iter_smoke_178.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/smoke_0731_01_sharedattention_antisymmetric_detail_decoder_4iter
...
echo "[$(date '+%F %T')] fresh 0731_01 real-data smoke" \
    >> "${WORK_DIR}/launch.log"
...
"${PYTHON_ROOT}/python" \
    projects/multispec_pair_rotated_rtdetr/tools/check_antisymmetric_detail_checkpoint.py \
    "${WORK_DIR}/iter_4.pth" >> "${WORK_DIR}/launch.log" 2>&1
