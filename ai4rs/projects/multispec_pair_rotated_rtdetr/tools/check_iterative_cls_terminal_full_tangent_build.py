"""Build 0803_19 and prove terminal full-tangent consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_19_iterative_cls_'
    'terminal_full_tangent_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_19_iterative_cls_terminal_full_tangent_'
    'decoder_4iter_smoke_178.py')
...
parent_config.model.decoder.pair_shared_terminal_full_tangent_refinement_decoder = False
...
assert new_config.model.decoder.pair_shared_terminal_full_tangent_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_log_size_periodic_angle_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_normalized_center_refinement_decoder
...
print('ITERATIVE_CLS_TERMINAL_FULL_TANGENT_BUILD_OK', {
