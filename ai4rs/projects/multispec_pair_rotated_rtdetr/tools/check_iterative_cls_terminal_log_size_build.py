"""Build 0804_03 and prove terminal log-size consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0804_03_iterative_cls_'
    'terminal_log_size_decoder_197.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_03_iterative_cls_terminal_log_size_'
    'decoder_4iter_smoke_197.py')
...
parent_config.model.decoder.pair_shared_terminal_log_size_refinement_decoder = False

decoder = new_config.model.decoder
assert decoder.pair_shared_terminal_log_size_refinement_decoder
...
assert not decoder.pair_shared_terminal_log_area_periodic_angle_refinement_decoder
assert not decoder.pair_shared_terminal_transport_shape_tangent_refinement_decoder
assert not decoder.terminal_position_tangent_transport_decoder
...
print('ITERATIVE_CLS_TERMINAL_LOG_SIZE_BUILD_OK', {
