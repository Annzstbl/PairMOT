...
WORK_DIR=/data4/litianhao/PairMmot/workdir_252/0723_02_paper_liquid_independent_diffproduct_pairdn_independent_le180_r18_coco_full_1200x900_bf16_orderedpairs_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_liquid_independent_diffproduct_pairdn_independent_le180_coco_full_1200x900_bf16_252.py
...
echo "[$(date '+%F %T')] fresh 0723_02 on GPUs ${CUDA_VISIBLE_DEVICES}" >> "${LOG}"
