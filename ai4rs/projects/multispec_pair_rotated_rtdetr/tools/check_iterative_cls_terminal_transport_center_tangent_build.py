"""Build 0803_25 and prove transported center tangent adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_25_iterative_cls_'
    'terminal_transport_center_tangent_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_25_iterative_cls_terminal_transport_'
    'center_tangent_decoder_4iter_smoke_178.py')
...
assert new_config.model.decoder.pair_shared_terminal_transport_center_tangent_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_transport_shape_tangent_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_transport_tangent_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_full_tangent_refinement_decoder
assert not new_config.model.bbox_head.iterative_cls_terminal_shared_margins
assert not new_config.model.bbox_head.iterative_cls_terminal_transport_margins
...
print('ITERATIVE_CLS_TERMINAL_TRANSPORT_CENTER_TANGENT_BUILD_OK', {
