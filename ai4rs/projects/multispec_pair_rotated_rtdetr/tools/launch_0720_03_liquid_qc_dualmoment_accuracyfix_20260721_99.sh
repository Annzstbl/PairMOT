...
WORK_DIR=/data4/litianhao/PairMmot/workdir_99/0720_03_paper_liquid_diffproduct_qc_dualmoment_r18_coco_full_1200x900_bf16_orderedpairs_accuracyfix_20260721_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_liquid_diffproduct_qc_dualmoment_coco_full_1200x900_bf16_99.py
...
echo "[$(date '+%F %T')] fresh 0720_03 with 20260721 training-accuracy fixes on GPUs ${CUDA_VISIBLE_DEVICES}" >> "${LOG}"
