...
WORK_DIR=/data4/litianhao/PairMmot/workdir_197/0717_03_paper_base_plus_liquid_hardsoftcontext_r18_coco_full_1200x900_bf16_orderedpairs_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_base_plus_liquid_hardsoftcontext_coco_full_1200x900_bf16_197.py
...
echo "[$(date '+%F %T')] fresh hard-sampled soft-context Liquid on 197 GPUs ${CUDA_VISIBLE_DEVICES}, port ${PORT}" >> "${LOG}"
