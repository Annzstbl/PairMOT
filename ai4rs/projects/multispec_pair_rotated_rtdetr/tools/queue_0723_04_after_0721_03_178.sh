...
LAUNCHER=${REPO}/projects/multispec_pair_rotated_rtdetr/tools/launch_0723_04_pairdn_cspr_178.sh
PREDECESSOR_CONFIG=o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_paper_liquid_bsr_diffproduct_accuracyfix_dnnegativefix_coco_full_1200x900_bf16_178.py
PREDECESSOR_DIR=/data4/litianhao/PairMmot/workdir_178/0721_03_paper_liquid_bsr_diffproduct_accuracyfix_dnnegativefix_r18_coco_full_1200x900_bf16_1xb8_fresh
LOCK=/data4/litianhao/PairMmot/workdir_178/.queue_0723_04.lock
SMOKE_CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_pairdn_paircoherent_le180_cspr_4iter_smoke_178.py
SMOKE_DIR=/data4/litianhao/PairMmot/workdir_178/smoke_0723_04_pairdn_cspr_4iter
MEMORY_LIMIT_MIB=2048

trap 'rc=$?; echo "[$(date '+"'"'%F %T'"'"')] FAILED_TO_START rc=${rc} command=${BASH_COMMAND}"; exit ${rc}' ERR
exec 9>"${LOCK}"
flock -n 9 || { echo "another 0723_04 queue is active"; exit 3; }
...
echo "[$(date '+%F %T')] smoke passed; launching formal 0723_04"
exec bash "${LAUNCHER}"
