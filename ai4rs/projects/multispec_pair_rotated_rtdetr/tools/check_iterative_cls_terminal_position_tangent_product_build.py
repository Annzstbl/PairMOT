"""Build 0803_27 and prove position/product tangent adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0803_27_iterative_cls_'
    'terminal_position_tangent_product_decoder_99.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_27_iterative_cls_terminal_position_'
    'tangent_product_decoder_4iter_smoke_99.py')
...
assert decoder.terminal_position_tangent_product_decoder
...
assert not decoder.pair_shared_progressive_log_shape_periodic_angle_refinement_decoder
assert not decoder.pair_shared_normalized_center_refinement_decoder
...
print('ITERATIVE_CLS_TERMINAL_POSITION_TANGENT_PRODUCT_BUILD_OK', {
