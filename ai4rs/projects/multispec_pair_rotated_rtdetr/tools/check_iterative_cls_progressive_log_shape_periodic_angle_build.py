"""Build 0803_12 and prove the progressive schedule adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0803_12_iterative_cls_'
    'progressive_log_shape_periodic_angle_decoder_252.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_12_iterative_cls_progressive_log_shape_'
...
parent_config.model.decoder.pair_shared_progressive_log_shape_periodic_angle_refinement_decoder = False
...
assert new_config.model.decoder.pair_shared_progressive_log_shape_periodic_angle_refinement_decoder
...
print('ITERATIVE_CLS_PROGRESSIVE_LOG_SHAPE_PERIODIC_ANGLE_BUILD_OK', {
