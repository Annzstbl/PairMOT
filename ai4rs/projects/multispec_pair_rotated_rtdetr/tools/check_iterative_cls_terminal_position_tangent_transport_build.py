"""Build 0803_28 and prove position/full tangent adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0803_28_iterative_cls_'
    'terminal_position_tangent_transport_decoder_197.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_28_iterative_cls_terminal_position_'
    'tangent_transport_decoder_4iter_smoke_197.py')
...
assert decoder.terminal_position_tangent_transport_decoder
...
print('ITERATIVE_CLS_TERMINAL_POSITION_TANGENT_TRANSPORT_BUILD_OK', {
