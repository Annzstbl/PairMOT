"""Build and compare 0801_12 against its unchanged parent."""
...
NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0801_12_terminal_pair_'
    'common_objectness_residual_decoder_99.py')
SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0801_12_terminal_pair_common_objectness_'
...
parent_config.model.bbox_head.terminal_pair_common_objectness_residual = False

assert new_config.model.bbox_head.terminal_pair_common_objectness_residual
...
assert new_keys == [
    'bbox_head.terminal_pair_common_objectness_residual_branch.bias',
    'bbox_head.terminal_pair_common_objectness_residual_branch.weight',
]
print('TERMINAL_PAIR_COMMON_OBJECTNESS_RESIDUAL_BUILD_OK', {
