"""Build 0804_14 and prove the hemisphere boundary adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0804_14_iterative_cls_terminal_'
    'transport_hemisphere_boundary_center_log_shape_consensus_decoder_99.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_14_iterative_cls_terminal_transport_'
    'hemisphere_boundary_center_log_shape_consensus_decoder_4iter_smoke_99.py')
...
assert decoder.pair_shared_terminal_transport_hemisphere_boundary_center_log_shape_consensus_refinement_decoder
for flag in (
...
print('ITERATIVE_CLS_TERMINAL_HEMISPHERE_BOUNDARY_CENTER_BUILD_OK', {
