...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0731_06_sharedattention_regression_enveloped_detail_decoder_178.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/0731_06_paper_base_liquid_encoder_p5temporal_dualevidence_decoder_sharedattention_regressionenvelopeddetail_pairdn_paircoherent_le180_r18_coco_full_1200x900_bf16_1xb8_fresh
...
echo "[$(date '+%F %T')] fresh 0731_06 commit $(git rev-parse --short HEAD)" \
    >> "${WORK_DIR}/launch.log"
