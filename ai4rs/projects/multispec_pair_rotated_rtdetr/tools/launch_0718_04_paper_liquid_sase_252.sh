...
WORK_DIR=/data4/litianhao/PairMmot/workdir_252/0718_04_paper_liquid_adaptiveanchor_sase_r18_coco_full_1200x900_bf16_orderedpairs_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_liquid_adaptiveanchor_sase_coco_full_1200x900_bf16_252.py
...
echo "[$(date '+%F %T')] fresh SASE-Liquid on GPUs ${CUDA_VISIBLE_DEVICES}, port ${PORT}" >> "${LOG}"
