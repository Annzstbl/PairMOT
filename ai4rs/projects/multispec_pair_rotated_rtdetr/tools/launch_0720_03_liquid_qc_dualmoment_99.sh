...
WORK_DIR=/data4/litianhao/PairMmot/workdir_99/0720_03_paper_liquid_diffproduct_qc_dualmoment_r18_coco_full_1200x900_bf16_orderedpairs_fresh
...
echo "[$(date '+%F %T')] fresh 0720_03 dual-moment conservation on GPUs ${CUDA_VISIBLE_DEVICES}" >> "${LOG}"
