...
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/0721_03_paper_liquid_bsr_diffproduct_accuracyfix_dnnegativefix_r18_coco_full_1200x900_bf16_1xb8_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_paper_liquid_bsr_diffproduct_accuracyfix_dnnegativefix_coco_full_1200x900_bf16_178.py
...
echo "[$(date '+%F %T')] fresh 0721_03 BSR + corrected negative DN on 178 GPU 0, bs=8" >> "${LOG}"
