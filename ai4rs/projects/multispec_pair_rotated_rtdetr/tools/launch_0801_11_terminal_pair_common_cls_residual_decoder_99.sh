...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0801_11_terminal_pair_common_cls_residual_decoder_99.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_99/0801_11_paper_base_liquid_encoder_p5temporal_dualevidence_decoder_terminalpaircommonclsresidual_pairdn_paircoherent_le180_r18_coco_full_1200x900_bf16_2xb4_fresh
...
echo "[$(date '+%F %T')] fresh formal 0801_11 commit $(git rev-parse --short HEAD)" \
    >> "${WORK_DIR}/launch.log"
exec "${PYTHON_ROOT}/torchrun" --nproc_per_node=2 --master_port=29822 \
