"""Build 0803_23 and prove transported tangent consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_23_iterative_cls_'
    'terminal_transport_tangent_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_23_iterative_cls_terminal_transport_'
    'tangent_decoder_4iter_smoke_178.py')
...
parent_config.model.decoder.pair_shared_terminal_transport_tangent_refinement_decoder = False
...
assert new_config.model.decoder.pair_shared_terminal_transport_tangent_refinement_decoder
...
print('ITERATIVE_CLS_TERMINAL_TRANSPORT_TANGENT_BUILD_OK', {
