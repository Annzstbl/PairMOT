"""Build 0803_03 and prove that its angle projection adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_03_iterative_cls_pair_'
    'shared_angle_refinement_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_03_iterative_cls_pair_shared_angle_'
    'refinement_decoder_4iter_smoke_178.py')
...
parent_config.model.decoder.pair_shared_angle_refinement_decoder = False

assert new_config.model.decoder.pair_shared_angle_refinement_decoder
...
print('ITERATIVE_CLS_PAIR_SHARED_ANGLE_REFINEMENT_BUILD_OK', {
