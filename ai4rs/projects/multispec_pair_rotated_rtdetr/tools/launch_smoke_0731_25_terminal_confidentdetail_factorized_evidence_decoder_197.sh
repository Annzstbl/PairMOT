...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0731_25_terminal_confidentdetail_factorized_evidence_decoder_4iter_smoke_197.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_197/smoke_0731_25_terminal_confidentdetail_factorized_evidence_4iter
...
echo "[$(date '+%F %T')] fresh 0731_25 real-data DDP smoke" >> "${WORK_DIR}/launch.log"
