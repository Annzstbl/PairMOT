"""Build 0803_11 and prove the late consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_11_iterative_cls_'
    'late_log_size_periodic_angle_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_11_iterative_cls_late_log_size_'
...
parent_config.model.decoder.pair_shared_late_log_size_periodic_angle_refinement_decoder = False
...
assert new_config.model.decoder.pair_shared_late_log_size_periodic_angle_refinement_decoder
...
print('ITERATIVE_CLS_LATE_LOG_SIZE_PERIODIC_ANGLE_BUILD_OK', {
