"""Build 0803_04 and prove periodic angle consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_04_iterative_cls_pair_'
    'shared_periodic_angle_refinement_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_04_iterative_cls_pair_shared_periodic_'
    'angle_refinement_decoder_4iter_smoke_178.py')
...
print('ITERATIVE_CLS_PAIR_SHARED_PERIODIC_ANGLE_REFINEMENT_BUILD_OK', {
