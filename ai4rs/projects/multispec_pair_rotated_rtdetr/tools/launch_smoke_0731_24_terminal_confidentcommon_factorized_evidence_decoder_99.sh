...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0731_24_terminal_confidentcommon_factorized_evidence_decoder_4iter_smoke_99.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_99/smoke_0731_24_terminal_confidentcommon_factorized_evidence_4iter
...
echo "[$(date '+%F %T')] fresh 0731_24 real-data DDP smoke" >> "${WORK_DIR}/launch.log"
"${PYTHON_ROOT}/torchrun" --nproc_per_node=2 --master_port=29595 \
