...
LAUNCHER=${REPO}/projects/multispec_pair_rotated_rtdetr/tools/launch_0727_08_encoder_dualbranchtrust_178.sh
...
LOCK=/data4/litianhao/PairMmot/workdir_178/.queue_0727_08.lock
QUEUE_LOG=/data4/litianhao/PairMmot/workdir_178/queue_0727_08.log
SMOKE_CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_base_liquid_encoder_p5temporal_dualbranchtrust_pairdn_paircoherent_le180_4iter_smoke_178.py
SMOKE_DIR=/data4/litianhao/PairMmot/workdir_178/smoke_0727_08_base_liquid_encoder_p5temporal_dualbranchtrust_4iter
MEMORY_LIMIT_MIB=2048

exec >> "${QUEUE_LOG}" 2>&1
trap 'rc=$?; echo "[$(date '+"'"'%F %T'"'"')] FAILED_TO_START rc=${rc} command=${BASH_COMMAND}"; exit ${rc}' ERR
exec 9>"${LOCK}"
flock -n 9 || { echo "another 0727_08 queue is active"; exit 3; }
...
echo "[$(date '+%F %T')] smoke passed; launching formal 0727_08"
exec bash "${LAUNCHER}"
