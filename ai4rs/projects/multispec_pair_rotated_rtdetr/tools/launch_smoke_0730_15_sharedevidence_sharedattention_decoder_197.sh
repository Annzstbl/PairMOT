...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0730_15_sharedevidence_sharedattention_decoder_4iter_smoke_197.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_197/smoke_0730_15_sharedevidence_sharedattention_decoder_4iter
...
echo "[$(date '+%F %T')] fresh 0730_15 real-data DDP smoke" \
    >> "${WORK_DIR}/launch.log"
...
"${PYTHON_ROOT}/python" \
    projects/multispec_pair_rotated_rtdetr/tools/check_sharedevidence_sharedattention_checkpoint.py \
