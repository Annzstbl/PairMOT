"""Build 0806_02 and prove log-SPD transport adds no parameters or state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0806_02_iterative_cls_terminal_'
    'transport_log_spd_product_tangent_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0806_02_iterative_cls_terminal_transport_'
    'log_spd_product_tangent_decoder_4iter_smoke_178.py')
...
assert decoder.pair_shared_terminal_transport_log_spd_product_tangent_refinement_decoder
for flag in (
...
print('ITERATIVE_CLS_TERMINAL_LOG_SPD_PRODUCT_TANGENT_BUILD_OK', {
