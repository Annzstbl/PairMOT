"""Build 0803_17 and prove that terminal margin consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_17_iterative_cls_'
    'terminal_shared_margins_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_17_iterative_cls_terminal_'
    'shared_margins_decoder_4iter_smoke_178.py')
...
assert head_config.iterative_cls_terminal_shared_margins
...
print('ITERATIVE_CLS_TERMINAL_SHARED_MARGINS_BUILD_OK', {
