...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0801_05_symmetric_feature_decoder_4iter_smoke_178.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/smoke_0801_05_symmetric_feature_decoder_4iter
...
echo "[$(date '+%F %T')] fresh 0801_05 real-data smoke" \
    >> "${WORK_DIR}/launch.log"
...
"${PYTHON_ROOT}/python" \
    projects/multispec_pair_rotated_rtdetr/tools/check_symmetric_feature_checkpoint.py \
