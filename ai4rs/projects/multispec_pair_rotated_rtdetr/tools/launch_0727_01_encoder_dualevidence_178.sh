...
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/0727_01_paper_base_liquid_encoder_p5temporal_dualevidence_pairdn_paircoherent_le180_r18_coco_full_1200x900_bf16_1xb8_fresh
...
echo "[$(date '+%F %T')] fresh 0727_01 dual-evidence temporal encoder, bs=8" >> "${LOG}"
