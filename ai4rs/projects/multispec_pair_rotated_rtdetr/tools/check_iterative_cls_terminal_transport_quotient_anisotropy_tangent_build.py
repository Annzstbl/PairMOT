"""Build 0804_17 and prove quotient-anisotropy tangent adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0804_17_iterative_cls_terminal_'
    'transport_quotient_anisotropy_tangent_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_17_iterative_cls_terminal_transport_'
    'quotient_anisotropy_tangent_decoder_4iter_smoke_178.py')
...
assert decoder.pair_shared_terminal_transport_quotient_anisotropy_tangent_refinement_decoder
for flag in (
...
print('ITERATIVE_CLS_TERMINAL_QUOTIENT_ANISOTROPY_TANGENT_BUILD_OK', {
