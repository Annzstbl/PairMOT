...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0801_09_iterative_cls_dn_isolated_e2e_decoder_178.py
...
echo "[$(date '+%F %T')] fresh formal 0801_09 commit $(git rev-parse --short HEAD)" \
    >> "${WORK_DIR}/launch.log"
