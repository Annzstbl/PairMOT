"""Build 0804_12 and prove spherical-midpoint transport adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0804_12_iterative_cls_terminal_'
    'transport_spherical_midpoint_center_log_shape_consensus_decoder_99.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_12_iterative_cls_terminal_transport_'
    'spherical_midpoint_center_log_shape_consensus_decoder_4iter_smoke_99.py')
...
assert decoder.pair_shared_terminal_transport_spherical_midpoint_center_log_shape_consensus_refinement_decoder
for flag in (
    ...
    assert not decoder.get(flag, False), flag
...
print('ITERATIVE_CLS_TERMINAL_SPHERICAL_MIDPOINT_CENTER_LOG_SHAPE_BUILD_OK', {
