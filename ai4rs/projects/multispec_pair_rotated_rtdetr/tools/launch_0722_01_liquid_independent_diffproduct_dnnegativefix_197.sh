...
WORK_DIR=/data4/litianhao/PairMmot/workdir_197/0722_01_paper_liquid_independent_diffproduct_dnnegativefix_r18_coco_full_1200x900_bf16_orderedpairs_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_liquid_independent_diffproduct_dnnegativefix_coco_full_1200x900_bf16_197.py
...
echo "[$(date '+%F %T')] fresh 0722_01 strict 0718_01 rerun with corrected negative DN" >> "${LOG}"
