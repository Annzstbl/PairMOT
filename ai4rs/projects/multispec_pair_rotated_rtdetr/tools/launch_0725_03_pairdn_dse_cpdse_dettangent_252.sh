...
WORK_DIR=/data4/litianhao/PairMmot/workdir_252/0725_03_paper_liquid_pairdn_paircoherent_le180_dse_cpdse_dettangent_r18_coco_full_1200x900_bf16_orderedpairs_fast_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_liquid_pairdn_paircoherent_le180_dse_cpdse_dettangent_coco_full_1200x900_bf16_252.py
...
echo "[$(date '+%F %T')] fresh 0725_03 PairDN + DSE + detection-tangent CP-DSE" >> "${LOG}"
