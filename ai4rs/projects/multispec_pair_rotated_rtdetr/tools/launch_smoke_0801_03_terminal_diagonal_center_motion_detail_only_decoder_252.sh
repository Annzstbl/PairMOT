...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0801_03_terminal_diagonal_center_motion_detail_only_decoder_4iter_smoke_252.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_252/smoke_0801_03_terminal_diagonal_center_motion_detail_only_4iter
set +u
...
echo "[$(date '+%F %T')] fresh 0801_03 real-data DDP smoke" >> "${WORK_DIR}/launch.log"
"${PYTHON_ROOT}/torchrun" --nproc_per_node=2 --master_port=29803 \
...
"${PYTHON_ROOT}/python" projects/multispec_pair_rotated_rtdetr/tools/check_terminal_diagonal_detail_only_checkpoint.py "${WORK_DIR}/iter_4.pth" >> "${WORK_DIR}/launch.log" 2>&1
