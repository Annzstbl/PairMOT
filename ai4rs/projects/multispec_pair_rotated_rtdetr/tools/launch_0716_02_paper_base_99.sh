...
WORK_DIR=/data4/litianhao/PairMmot/workdir_99/0716_02_paper_base_r18_coco_full_1200x900_bf16_orderedpairs_restart
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_base_coco_full_1200x900_bf16_99.py
...
echo "[$(date '+%F %T')] fresh ordered-pair paper baseline on GPUs ${CUDA_VISIBLE_DEVICES}, port ${PORT}" >> "${LOG}"
