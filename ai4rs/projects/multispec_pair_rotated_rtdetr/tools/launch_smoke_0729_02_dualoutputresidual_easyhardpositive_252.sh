...
WORK_DIR=/data4/litianhao/PairMmot/workdir_252/smoke_0729_02_dualevidence_decoder_dualoutputresidual_easyhardpositive_4iter
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_dualevidence_decoder_dualoutputresidual_easyhardpositive_4iter_smoke_252.py
...
echo "[$(date '+%F %T')] fresh 0729_02 dual-output residual smoke" >> "${LOG}"
