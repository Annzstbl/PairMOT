...
LAUNCHER=${REPO}/projects/multispec_pair_rotated_rtdetr/tools/launch_0721_05_liquid_dse_accuracyfix_99.sh
LOCK=/data4/litianhao/PairMmot/workdir_99/.queue_0721_05.lock
PREDECESSOR=o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_liquid_diffproduct_qc_dualmoment_coco_full_1200x900_bf16_99.py
SMOKE_CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_liquid_dse_accuracyfix_4iter_smoke_99.py
SMOKE_DIR=/data4/litianhao/PairMmot/workdir_99/smoke_0721_05_dse_4iter
MEMORY_LIMIT_MIB=2048

exec 9>"${LOCK}"
if ! flock -n 9; then
    echo "[$(date '+%F %T')] another 0721_05 queue is active"
    exit 3
fi
