"""Build 0803_16 and prove terminal center consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_16_iterative_cls_'
    'terminal_normalized_center_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_16_iterative_cls_terminal_normalized_'
    'center_decoder_4iter_smoke_178.py')
...
parent_config.model.decoder.pair_shared_terminal_normalized_center_refinement_decoder = False

assert new_config.model.decoder.pair_shared_terminal_normalized_center_refinement_decoder
assert not new_config.model.decoder.pair_shared_normalized_center_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_periodic_angle_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_log_size_periodic_angle_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_log_area_periodic_angle_refinement_decoder
...
print('ITERATIVE_CLS_TERMINAL_NORMALIZED_CENTER_BUILD_OK', {
