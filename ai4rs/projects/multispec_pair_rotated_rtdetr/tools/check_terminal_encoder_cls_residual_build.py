"""Build and compare 0801_10 against its unchanged Encoder parent."""
...
NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0801_10_terminal_'
    'encoder_cls_residual_decoder_197.py')
SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0801_10_terminal_encoder_cls_'
    'residual_decoder_4iter_smoke_197.py')
...
parent_config.model.bbox_head.terminal_encoder_cls_residual = False

assert new_config.model.bbox_head.terminal_encoder_cls_residual is True
assert new_config.model.bbox_head.iterative_cls_residual is False
assert new_config.model.decoder.shared_attention_decoder is False
...
expected_parameter_delta = (
    2 * (new_model.bbox_head.embed_dims + 1)
...
assert new_keys == [
    'bbox_head.terminal_encoder_cls_residual_curr.bias',
    'bbox_head.terminal_encoder_cls_residual_curr.weight',
    'bbox_head.terminal_encoder_cls_residual_prev.bias',
    'bbox_head.terminal_encoder_cls_residual_prev.weight',
]
assert new_model.bbox_head.terminal_encoder_cls_residual is True

print('TERMINAL_ENCODER_CLS_RESIDUAL_BUILD_OK', {
