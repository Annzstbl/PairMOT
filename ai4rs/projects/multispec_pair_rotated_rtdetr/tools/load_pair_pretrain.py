...
def ensure_pair_adapted_checkpoint(
    ...
    dst_ckpt = osp.join(cache_dir, 'pair_adapted_pretrain.pth')
    ...
    adapted_sd, stats = adapt_single_frame_ckpt_for_pair(state_dict)
    ...
    print(
        ...
        f'{stats["reg_branches_curr_copied"]} dropped_dn={stats["dropped_dn"]}')
    return dst_ckpt
