...
WORK_DIR=/data4/litianhao/PairMmot/workdir_197/0729_01_paper_base_liquid_encoder_p5temporal_dualevidence_decoder0708_03_pairdn_easyhardpositive_le180_r18_coco_full_1200x900_bf16_orderedpairs_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_base_liquid_encoder_p5temporal_dualevidence_decoder0708_03_pairdn_easyhardpositive_le180_coco_full_1200x900_bf16_197.py
...
echo "[$(date '+%F %T')] fresh 0729_01 0728_03 new DN + 0708_03 decoder" >> "${LOG}"
