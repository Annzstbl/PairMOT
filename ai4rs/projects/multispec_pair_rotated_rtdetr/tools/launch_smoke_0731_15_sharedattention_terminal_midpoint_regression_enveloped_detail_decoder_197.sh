...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0731_15_sharedattention_terminal_midpoint_regression_enveloped_detail_decoder_4iter_smoke_197.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_197/smoke_0731_15_sharedattention_terminal_midpoint_regression_enveloped_detail_decoder_4iter
...
echo "[$(date '+%F %T')] fresh 0731_15 real-data DDP smoke" \
    >> "${WORK_DIR}/launch.log"
"${PYTHON_ROOT}/torchrun" --nproc_per_node=2 --master_port=29962 \
...
"${PYTHON_ROOT}/python" \
    projects/multispec_pair_rotated_rtdetr/tools/check_sharedattention_terminal_midpoint_enveloped_detail_checkpoint.py \
