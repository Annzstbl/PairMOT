...
WORK_DIR=/data4/litianhao/PairMmot/workdir_99/0719_06_paper_base_longtail_reweight_r18_coco_full_1200x900_bf16_orderedpairs_fresh
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_paper_base_longtail_reweight_coco_full_1200x900_bf16_99.py
...
echo "[$(date '+%F %T')] fresh Paper Base + long-tail reweight on GPUs ${CUDA_VISIBLE_DEVICES}, port ${PORT}" >> "${LOG}"
