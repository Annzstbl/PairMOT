...
LAUNCHER=${REPO}/projects/multispec_pair_rotated_rtdetr/tools/launch_0727_10_encoder_detailredistribute_197.sh
...
LOCK=/data4/litianhao/PairMmot/workdir_197/.queue_0727_10.lock
QUEUE_LOG=/data4/litianhao/PairMmot/workdir_197/queue_0727_10.log
SMOKE_CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_base_liquid_encoder_p5temporal_detailredistribute_pairdn_paircoherent_le180_4iter_smoke_197.py
SMOKE_DIR=/data4/litianhao/PairMmot/workdir_197/smoke_0727_10_base_liquid_encoder_p5temporal_detailredistribute_4iter
MEMORY_LIMIT_MIB=2048

exec >> "${QUEUE_LOG}" 2>&1
trap 'rc=$?; echo "[$(date '+"'"'%F %T'"'"')] FAILED_TO_START rc=${rc} command=${BASH_COMMAND}"; exit ${rc}' ERR
exec 9>"${LOCK}"
flock -n 9 || { echo "another 0727_10 queue is active"; exit 3; }
...
echo "[$(date '+%F %T')] smoke passed; launching formal 0727_10"
exec bash "${LAUNCHER}"
