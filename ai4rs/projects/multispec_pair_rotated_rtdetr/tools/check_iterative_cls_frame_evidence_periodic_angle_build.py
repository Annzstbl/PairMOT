"""Build 0803_07 and prove the combined routes add no model state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0803_07_iterative_cls_'
    'frame_evidence_periodic_angle_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_07_iterative_cls_frame_evidence_'
...
parent_config.model.decoder.frame_evidence_cls_decoder = False
parent_config.model.decoder.pair_shared_periodic_angle_refinement_decoder = (
    False)

assert new_config.model.decoder.frame_evidence_cls_decoder
assert new_config.model.decoder.pair_shared_periodic_angle_refinement_decoder
...
print('ITERATIVE_CLS_FRAME_EVIDENCE_PERIODIC_ANGLE_BUILD_OK', {
