...
CONFIG=projects/multispec_pair_rotated_rtdetr/configs/smoke/o2_pair_rtdetr_r18vd_0731_21_terminal_orthogonal_factorized_evidence_decoder_4iter_smoke_178.py
WORK_DIR=/data4/litianhao/PairMmot/workdir_178/smoke_0731_21_terminal_orthogonal_factorized_evidence_decoder_4iter
...
echo "[$(date '+%F %T')] fresh 0731_21 real-data smoke" \
    >> "${WORK_DIR}/launch.log"
