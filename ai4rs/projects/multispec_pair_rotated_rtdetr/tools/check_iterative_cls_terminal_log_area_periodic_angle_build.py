"""Build 0803_14 and prove terminal area consensus adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_2xb4_72e_hsmot_0803_14_iterative_cls_'
    'terminal_log_area_periodic_angle_decoder_252.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0803_14_iterative_cls_terminal_log_area_'
    'periodic_angle_decoder_4iter_smoke_252.py')
...
parent_config.model.decoder.pair_shared_terminal_log_area_periodic_angle_refinement_decoder = False

assert new_config.model.decoder.pair_shared_terminal_log_area_periodic_angle_refinement_decoder
assert not new_config.model.decoder.pair_shared_terminal_log_size_periodic_angle_refinement_decoder
assert not new_config.model.decoder.pair_shared_late_log_size_periodic_angle_refinement_decoder
assert not new_config.model.decoder.pair_shared_progressive_log_shape_periodic_angle_refinement_decoder
assert not new_config.model.decoder.pair_shared_log_size_periodic_angle_refinement_decoder
assert not new_config.model.decoder.pair_shared_log_area_periodic_angle_refinement_decoder
...
print('ITERATIVE_CLS_TERMINAL_LOG_AREA_PERIODIC_ANGLE_BUILD_OK', {
