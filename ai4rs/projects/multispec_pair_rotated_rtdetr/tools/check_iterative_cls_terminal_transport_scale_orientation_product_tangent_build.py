"""Build 0806_05 and prove the split tangent adds no parameters or state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0806_05_iterative_cls_terminal_'
    'transport_scale_orientation_product_tangent_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0806_05_iterative_cls_terminal_transport_'
    'scale_orientation_product_tangent_decoder_4iter_smoke_178.py')
...
assert decoder.pair_shared_terminal_transport_scale_orientation_product_tangent_refinement_decoder
for flag in (
...
print('ITERATIVE_CLS_TERMINAL_SCALE_ORIENTATION_PRODUCT_TANGENT_BUILD_OK', {
