"""Build 0804_10 and prove covariant Frenet transport adds no state."""
...
DEFAULT_NEW_CONFIG = (
    ...
    'o2_pair_rtdetr_r18vd_1xb8_72e_hsmot_0804_10_iterative_cls_terminal_'
    'transport_covariant_frenet_product_tangent_decoder_178.py')
DEFAULT_SMOKE_CONFIG = (
    'projects/multispec_pair_rotated_rtdetr/configs/smoke/'
    'o2_pair_rtdetr_r18vd_0804_10_iterative_cls_terminal_transport_'
    'covariant_frenet_product_tangent_decoder_4iter_smoke_178.py')
...
assert decoder.pair_shared_terminal_transport_covariant_frenet_product_tangent_refinement_decoder
...
for flag in (
    ...
    assert not decoder.get(flag, False)
...
print('ITERATIVE_CLS_TERMINAL_COVARIANT_FRENET_PRODUCT_TANGENT_BUILD_OK', {
