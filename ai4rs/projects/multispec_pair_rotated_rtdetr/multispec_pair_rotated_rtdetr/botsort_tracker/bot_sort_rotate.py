...
from .bbox_utils import poly2obb_np_woscore, obb2poly_np_woscore
...
class BoTSORT(object):
    def __init__(self, args, frame_rate=30):
        ...
        # ReID module
        self.proximity_thresh = args.proximity_thresh if hasattr(args, 'proximity_thresh') else None
        self.appearance_thresh = args.appearance_thresh if hasattr(args, 'appearance_thresh') else None
