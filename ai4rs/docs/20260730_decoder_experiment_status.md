...
| 服务器 | 实验 | 状态 | 结构与判定方式 |
| --- | --- | --- | --- |
| AutoDL GPU0 | `0811_02 final product-tangent standard warmup4 + cosine68 peak×8/3 corrected fresh v2 1x8` | `RUNNING/E5I350/E4_COMPLETE/AUTO_FINALIZER_ACTIVE/TO_E72` | e4同点cls/det `34.903/42.562`、sum `77.465`；DetA/AssA、AP、5416/50检测、50/50轨迹、TrackEval、checkpoint SHA与1,284个浮点tensor均闭环。仅作早期诊断，不否决decoder。 |
