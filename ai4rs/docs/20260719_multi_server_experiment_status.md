...
| 178 | `0803_23 transported full tangent finite-fresh`（当前 GPU0） | RUNNING/TO_E8+；e4 `36.342/44.739`，相对原 decoder `+2.036/+6.149`，完整评测通过，PGID `3151184` | 同一 fresh 轨迹继续 e8/e12；`0803_24 shape-only`、`0803_25 center-only` PREPARED/NO_GPU；GPU 序号不固定 | `/data4/litianhao/PairMmot/workdir_178` |
