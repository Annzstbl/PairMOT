...
- 197/e68 closes at `55.238/62.217=117.455`; cls/det DetA/AssA are `45.258/69.292` and `54.006/74.041`, with pair mAP/AP50 `0.3186/0.5350`. The strict gaps are `0.025/0.382/0.407`.
- `epoch_68.pth`, `5,416/50` detection records, 51 detection files, and 28 CSV/108 TrackEval files are complete. Formal training has continued into e69 with finite total/DN/encoder losses and grad norm. Per user closeout scope, only e72 remains and no new candidate will be launched.
...
## 2026-08-13 13:22 CST: 99 and 178 e56 complete
...
## 2026-08-13 14:40 CST: 99 and 178 e60 complete
...
## 2026-08-13 15:17 CST: fixed-252 e44 complete

- Fixed-252 `0812_05` e44 cls HOTA/DetA/AssA is `55.079/46.021/67.586`; det is `61.692/53.958/72.967`, sum `116.771`, and pair mAP/AP50 is `0.3146/0.5285`. Versus e40, HOTA rises by `0.626/0.622`, sum by `1.248`.
- The e44 checkpoint, 5,416/50 detection, 51 detection files and 28 CSV/108 TrackEval files are complete. Shared `/data4` reads and NFS writes made the asynchronous closure take 1294.5 seconds, but it remained live and completed normally. Training continues in e45 on fixed GPU0/1; retain through the post-e48 decay window.

## 2026-08-13 15:57 CST: 99 and 178 e64 complete
...
## 2026-08-13 17:02 CST: 99 e68 and 197 e52 complete

- 99 `0812_03` e68 cls HOTA/DetA/AssA is `54.946/45.607/68.196`; det is `62.240/54.464/73.523`, sum `117.186`, and pair mAP/AP50 is `0.3120/0.5299`. Versus e64 it falls `0.336/0.063`; retain to e72 despite the cls regression.
- 197 `0813_01` e52 cls HOTA/DetA/AssA is `54.327/45.524/66.526`; det is `61.639/53.738/73.072`, sum `115.966`, and pair mAP/AP50 is `0.3121/0.5249`. Versus e48 it changes `-0.128/+0.272`; its floor differs only after e60.
- The 457,886,518/435,698,023-byte checkpoints, 5,416/50 detection, 51 detection files and 28 CSV/108 TrackEval files are complete. Evaluations took 291.4/344.8 seconds; finite training continues in e69/e53 with no traceback/OOM/NCCL error.
...
## 2026-08-13 19:35 CST: 197/e60 and 252/e56 closeout nodes
...
- 197 `0813_01` e36 cls HOTA/DetA/AssA is `52.723/43.544/66.080`; det is `59.599/51.691/71.081`, sum `112.322`, and pair mAP/AP50 is `0.2889/0.4900`.
- Relative to e32, cls/det HOTA rise by `0.800/0.467`, sum by `1.267`. The 413,852,839-byte checkpoint, 5,416/50 detection, 51 detection files, 28 CSV/108 TrackEval files and 348.7-second asynchronous evaluation are complete; finite training resumed at e37i400 on GPU4/5.
- The 25% floor diverges only after e60, so this is healthy trajectory evidence rather than an early judgment of the intervention. Continue to e72.
...
- The user reconfirmed 252 as an added dual-GPU resource fixed to GPU0/1 and the slowest host. Live state shows both cards at about 21.4 GiB on formal `0812_05`; the 414,020,342-byte e36 checkpoint exists, asynchronous TrackEval is active, and training has resumed at e37i150 with finite formal losses and gradient.
- GPU2/3 remain idle. Because the healthy formal line already occupies the authorized cards, do not launch another job or restart it; close e36 and continue toward the post-e48 decay window and e72.
...
## 2026-08-13 06:39 CST: 252 e20 complete

- 252 `0812_05` e20 cls HOTA/DetA/AssA is `49.781/41.113/62.132`; det is
  `57.618/50.157/68.584`, sum `107.399`, and pair mAP/AP50 is `0.2665/0.4628`. The 392,031,030-byte
  checkpoint, 5,416/50 detection and 383.3-second TrackEval are complete; training resumed at e21i350 on
...
## 2026-08-13 07:42 CST: 197 e20 complete and compared with 252

- 197 `0813_01` e20 cls HOTA/DetA/AssA is `50.549/42.128/62.547`; det is
  `57.962/50.517/68.936`, sum `108.511`, and pair mAP/AP50 is `0.2773/0.4765`.
- The 391,937,447-byte checkpoint, detection export for all 50 sequences, 108 TrackEval files and
...
## 2026-08-13 08:19 CST: 99 and 178 e40 complete

- 99 e40 cls HOTA/DetA/AssA is `54.482/45.585/66.825`; det is
  `61.506/53.885/72.709`, sum `115.988`, pair mAP/AP50 `0.3101/0.5251`.
  It improves e36 HOTA by `0.852/0.353` and the sum by `1.205`.
- 178 e40 cls HOTA/DetA/AssA is `54.237/45.062/67.608`; det is
  `61.232/53.711/72.242`, sum `115.469`, pair mAP/AP50 `0.3088/0.5242`.
  It improves e36 HOTA by `0.529/0.673` and the sum by `1.202`.
...
- 252 e28 is `51.270/59.249`, sum `110.519`, with DetA/AssA
  `43.535/61.823` and `51.414/70.672`, pair mAP/AP50 `0.2857/0.4901`.
  It improves e24 by `0.564/0.756`; checkpoint, detection and 388.8-second TrackEval are complete.
- 99 e44 is `54.902/61.655`, sum `116.557`, with cls DetA/AssA `45.841/67.584`, det
  `54.134/72.639`, pair `0.3113/0.5288`. 178 e44 is `54.369/61.345`, sum `115.714`,
  with cls `45.100/68.013`, det `53.841/72.353`, pair `0.3114/0.5256`.
...
## 2026-08-13 10:50 CST: 99/178 e48 and 252 e32 complete

- 99 e48 is cls `54.864/45.826/67.524`, det `61.770/54.139/72.882`, sum `116.634`, and pair
  mAP/AP50 `0.3113/0.5288`. Relative to e44, cls/det changes `-0.038/+0.115`; sum rises `0.077`.
- 178 e48 is cls `54.828/45.461/68.582`, det `61.578/54.056/72.578`, sum `116.406`, pair
  `0.3147/0.5285`. Relative to e44, both HOTA values rise `0.459/0.233`; 99 leads the sum by `0.228`.
  Both e48 checkpoints, all 50 detection sequences and 108 TrackEval files are complete.
- Fixed-252 e32 is cls `52.510/44.649/63.174`, det `60.173/52.186/71.833`, sum `112.683`, pair
...
## 2026-08-13 12:05 CST: 99 and 178 e52 complete

- 99 e52 cls HOTA/DetA/AssA is `55.178/46.051/67.944`; det is
  `62.080/54.286/73.423`, sum `117.258`, pair mAP/AP50 `0.3115/0.5282`.
  It gains `0.314/0.310` over e48 and is short of the strict target by `0.085/0.519/0.604`.
- 178 e52 cls is `55.252/45.775/69.180`; det is `61.783/54.225/72.838`, sum `117.035`, pair
  `0.3168/0.5322`. Four epochs of real WSD decay improve e48 by `0.424/0.205`, sum `0.629`.
- Both checkpoints, all 50 detection sequences and 108 TrackEval files are complete. 99 leads e52 det/sum
  by `0.297/0.223`, while 178 leads cls and AP. Keep both through e56/e60; neither is yet strict e72 success.

## 2026-08-13 05:16 CST：252 e16与四服务器现场状态

- 252固定GPU0/1的e16完整结果为cls/det HOTA `48.584/56.750`、sum `105.334`，
  DetA/AssA分别为`39.790/61.347`与`49.267/67.676`，pair mAP/AP50
  `0.2561/0.4444`。checkpoint、5416/50检测和异步TrackEval完整；较e12双升，继续e20。
...
## 2026-08-13 05:29 CST：99 e32闭环

- 99 floor-cosine e32为cls HOTA/DetA/AssA `53.339/44.762/65.416`，det
...
## 2026-08-13 01:52 CST：197 e72闭环失败，floor25 v2正式接替

- `0812_01` e72为`54.768/62.411`、sum `117.179`，DetA/AssA分别`45.460/67.856`与`54.483/73.825`，AP及5416/50 TrackEval完整，GPU4/5已释放。
- e68→e72表现为cls `-0.096`、det `+0.206`；据此启用标准WSD的单因素25% cosine floor，抑制尾部LR过低造成的cls回撤。
- 初版因252数据路径在训练前失败；v2修正为197路径并进入独立workdir。正式e1i50、GPU4/5、总/DN/encoder loss及梯度有限，状态`RUNNING/TO_E72`。

## 2026-08-13 02:05 CST：99/178 e20完整节点

- 99 e20 `51.991/58.832`、sum `110.823`；178 e20 `52.145/57.823`、sum `109.968`，检测与TrackEval完整。
- 178双DetA及pair/both AP更高，99双AssA更高且det AssA领先`2.525`，形成定位与关联互补证据。两线继续e24和成熟退火段，不作e20早停。

## 2026-08-12 23:43 CST：252 GPU0/1新增资源正式运行

- 固定GPU0/1实时空闲且无训练进程后，启动`0812_05`标准`warmup4+stable44+cosine24`双卡2x4 fresh；它复现178调度，保持全局batch8和全部模型/训练/推理协议不变。
- 按用户精简要求不做独立smoke与SHA；从252既有WSD仓库做本机隔离克隆，仅同步两个小文件。formal screen、双rank、GPU0/1约19.2 GiB、正式日志e1i100齐全，LR/loss/grad `1e-7/21.3921/120.7811`且总、DN、encoder项有限，登记RUNNING。
- 99/178 e12分别为`47.454/54.307`与`51.141/56.894`，对应sum `101.761/108.035`；178当前领先，但99的非零floor尚未进入作用窗口，两条均继续。
...
- e60 cls HOTA/DetA/AssA `54.108/44.464/67.776`，det `61.892/53.968/73.237`，sum `116.000`；pair mAP/AP50 `0.3110/0.5243`，both-independent `0.3499/0.5614`。
- 相对e56双HOTA提高`0.115/0.078`，sum提高`0.193`，cls AssA提高`0.827`；5416/50检测、28 CSV、108非空文件、50预测和异步完成指标齐全。e60仍低目标，但仅是稳定段终点，继续e64/e68/e72。
- 99/178均已完成e8训练并继续；其e4/e8只作为运行与调度诊断，不用于否决。

## 2026-08-12 21:02 CST：197 e56完整闭环，99/178 e4仅作诊断

- 197 e56 cls HOTA/DetA/AssA `53.993/44.659/66.949`，det `61.814/53.922/73.136`，sum `115.807`；pair mAP/AP50 `0.3110/0.5241`，both-independent `0.3469/0.5564`。
- 相对e52，sum仅`-0.002`；cls DetA回落`0.274`、AssA提高`0.122`，det DetA/AssA提高`0.033/0.038`。5416/50检测、28 CSV、108非空文件、50预测和完成标志齐全。当前训练e57i850，继续e60及退火后的e64/e72，不在平台点停线。
- 99/178 e4分别为`32.411/39.594`和`35.363/42.179`，完整异步评测后均继续e5。按既定原则，e4只确认warmup、正式日志和评测链路，不能否决decoder或预测e72。
...
- e60 cls HOTA/DetA/AssA `54.574/44.138/70.416`，det `62.387/54.595/73.734`，
  sum `116.961`；较e56双降`0.188/0.178`，三门槛差`0.689/0.212/0.901`。
- pair mAP/AP50 `0.3141/0.5179`、both-independent `0.3507/0.5508`；5416/50检测、
  28 CSV、108非空文件、50 predictions和异步完成标志齐全。
- 446,956,340-byte checkpoint SHA-256为
  `7054d214b9f08d6d3299368676754aadb759ec0373b40cc3ddbfd4d6c88f834f`，642个浮点
  tensor有限。训练已恢复e61i250，GPU0与finalizer正常；不以e60否决，继续e64/e72。

## 2026-08-12 15:07 CST：197新增GPU4/5正式WSD续训

- 新增197双卡资源按用户优先级使用GPU4/5；启动前六卡均为`1 MiB/0%`，未抢占外部任务。
- `0812_01`在独立commit `bda390f`和全新`...resume_e36_to_e72_v2`目录中，从共享252
  e36 checkpoint严格恢复到epoch/iter `36/37368`。e37 iter50/100日志的LR均为`1.5e-4`，
  loss为`9.0961/10.1237`，grad norm为`54.5817/66.3785`，总、DN与encoder项全部有限；
  screen、双rank、正式日志和GPU4/5占用五项门槛通过，登记`RUNNING`，先闭环e40后继续e72。
- 迭代式精确续训短测因MMEngine需顺序跳过37,368个dataloader step而终止，未产生训练迭代或
  checkpoint；该目录保留审计，不计为实验。正式epoch-loop已直接证明恢复语义和动态健康。

## 2026-08-12 13:41 CST：AutoDL e52完整闭环，197继续补齐独立e72对照

- AutoDL e52同一checkpoint为cls/det HOTA `54.853/62.489`、sum `117.342`；
  cls DetA/AssA `44.653/70.155`，det `54.712/73.802`；pair mAP/AP50
  `0.316115/0.523328`，both-independent `0.353151/0.556579`。
- checkpoint为435,952,628字节，SHA-256
  `25add0e1bb9be1a99fdee1caa62ab4c3dd73968a94dd5c4df7ba77680c68c1f8`，meta
  `52/53976`、711/712 states、1,284个model/EMA浮点tensor全部有限；5416条、50序列、
  50/50轨迹、28 CSV、108文件和异步完成标志完整。距目标`0.410/0.110/0.520`，继续e56。
- 197 GPU4/5正式resume持续到e69 iter950，另四卡保持空闲；训练值有限、无致命错误。
...
- e48同一checkpoint的cls HOTA/DetA/AssA为`54.833/44.783/69.907`，det为
  `62.278/54.658/73.407`，sum `117.111`；pair mAP/AP50为`0.3153/0.5230`，
  both-independent为`0.3532/0.5576`。5416条、50序列检测与50/50轨迹完整，
  28个CSV、108个非空评测文件，`track/async_done=1.0`，TrackEval自然耗时166.7秒。
- 430,449,716-byte checkpoint SHA-256为
  `f3b097eea376e6e2fcf796710273c9c991cad1905caae8f898427a57dc1c507f`，meta为
  `epoch=48/iter=49824`；model/EMA为711/712 states，全部2,776个浮点checkpoint
  tensor有限。
- 相对e44，cls/det HOTA双升`0.421/0.128`、联合升`0.549`；相对warmup12同点双升
  `0.017/0.302`、联合高`0.319`。训练已进入e49 iter250，继续e52成熟节点。
...
- e36同一checkpoint的cls HOTA/DetA/AssA为`52.655/43.231/67.442`，det为
  `61.636/53.823/73.165`，sum `114.291`；pair mAP/AP50为`0.302992/0.507713`，
  both-independent为`0.341717/0.546061`。5416条、50序列检测与50/50轨迹完整，
  28个CSV、108个非空评测文件，`track/async_done=1.0`，TrackEval自然耗时165.8秒。
- 413,988,020-byte checkpoint SHA-256为
  `b1966b8fbece648df39bf5b22add76ce1f0ee4aa8107d4fedd8c6f4f80ad9325`，meta为
  `epoch=36/iter=37368`；model/EMA为711/712 states，全部2,776个浮点checkpoint
  tensor有限。
- 相对e32，cls/det HOTA双升`0.439/0.437`、联合升`0.876`，DetA、AssA和四项AP均升；
  相对warmup12同点为`-0.253/+0.754`、联合高`0.501`。训练已进入e37 iter550，
  GPU0约31.4 GiB、数据盘余约9.0 GiB、训练数值有限；继续e40和成熟节点。
...
- e28同一checkpoint的cls HOTA/DetA/AssA为`52.385/43.178/66.550`，det为
  `60.607/53.180/71.563`，sum `112.992`；pair mAP/AP50为`0.304872/0.510172`，
  both-independent为`0.344541/0.550450`。5416条、50序列检测与50/50轨迹完整，
  28个CSV、108个非空评测文件，`track/async_done=1.0`，TrackEval自然耗时168.1秒。
- 402,998,260-byte checkpoint SHA-256为
  `2fcf004ca507577a6f577227613b21aef6b1072f65c9d4bbb0a51bef5b8ba2af`，meta为
  `epoch=28/iter=29064`；model/EMA为711/712 states，全部2,776个浮点checkpoint
  tensor有限。
- 相对warmup12同点，cls/det HOTA提高`0.411/0.889`、联合提高`1.300`；相对原始
  product-tangent父线为`-0.256/+1.621`，联合高`1.365`。训练已进入e29 iter900，
  GPU0约31.4 GiB、数据盘余约11 GiB、明确fatal扫描为0；继续e32和成熟节点。

## 2026-08-12 07:00 CST：AutoDL e24完整闭环，标准短warmup保持联合优势

- e24同一checkpoint的cls HOTA/DetA/AssA为`52.115/43.151/65.666`，det为
  `60.061/52.801/70.770`，sum `112.176`；pair mAP/AP50为`0.302287/0.506918`，
  both-independent为`0.342950/0.549071`。5416条、50序列检测与50/50轨迹完整，
  28个CSV、108个非空评测文件，`track/async_done=1.0`，TrackEval自然耗时169.1秒。
- 397,515,124-byte checkpoint SHA-256为
  `e71d3f7b896b4184d1b5201513c499a174ecac1012a04663cdfd9ce01725b2f7`，meta为
  `epoch=24/iter=24912`；model/EMA为711/712 states，全部2,776个浮点checkpoint
  tensor有限。
- 相对warmup12同点，cls/det HOTA提高`0.265/1.062`、联合提高`1.327`；相对原始
  product-tangent父线为`-0.363/+1.290`，联合仍高`0.927`。训练已进入e25 iter450，
  数据盘仍余约12 GiB；继续e28和成熟节点，不在e24停线。

## 2026-08-12 06:02 CST：AutoDL e20完整闭环，标准短warmup保持联合优势

- e20同一checkpoint的cls HOTA/DetA/AssA为`51.772/42.780/65.435`，det为
  `59.525/52.529/69.866`，sum `111.297`；pair mAP/AP50为`0.299258/0.503352`，
  both-independent为`0.340627/0.546798`。5416条、50序列检测与50/50轨迹完整，
  `track/async_done=1.0`，TrackEval自然耗时166.9秒。
- 392,033,012-byte checkpoint SHA-256为
  ...
  全部2,776个浮点checkpoint tensor有限。
- 相对warmup12同点，cls/det HOTA提高`0.544/1.489`；相对原始product-tangent父线
  为`-0.426/+1.393`，联合仍高`0.967`。训练已进入e21，数据盘仍余约12 GiB；继续e24
  和成熟节点，不以单点cls回撤提前否决。

## 2026-08-12 05:08 CST：AutoDL e16完整闭环，成熟前移优势仍双正

- e16同一checkpoint的cls HOTA/DetA/AssA为`51.488/42.891/64.243`，det为
  `58.779/52.124/68.640`，sum `110.267`；pair mAP/AP50为`0.296979/0.499316`，
  both-independent为`0.340233/0.546737`。5416条、50序列检测与50/50轨迹完整，
  `track/async_done=1.0`，TrackEval自然耗时167.2秒。
- 386,538,932-byte checkpoint SHA-256为
  ...
  1,284个浮点model/EMA tensor及全部递归checkpoint浮点tensor有限。
- 相对warmup12同点，cls/det HOTA提高`2.161/2.082`，DetA/AssA与AP比较均为正；
  相对原始product-tangent父线e16也提高`0.268/1.409`。训练已进入e17，数据盘仍余
  约12.3 GiB；继续e20和成熟节点，不以e16未达最终阈值提前否决。
...
- e8同一checkpoint的cls HOTA/DetA/AssA为`44.755/35.387/59.040`，det为
  `51.724/44.113/63.197`，sum `96.479`；cls/det MOTA分别`34.833/46.495`，
  IDF1分别`50.385/58.406`。pair mAP/AP50为`0.230501/0.389489`，
  both-independent为`0.268457/0.435281`。5416条、50序列检测与50/50非空轨迹完整，
  `track/async_done=1.0`，TrackEval自然耗时158.2秒。
- `epoch_8.pth`为375,554,740字节，SHA-256
  `250c3b2471ea5f1a5e54e0b6337b29c93138a31d43e9a57acf4566759db4e649`，meta为
  `epoch=8/iter=8304`；model/EMA为711/712 states，optimizer为497 states/groups，
  1,284个浮点model/EMA tensor全部有限。训练自然恢复到e9 iter200，真实运行错误为0。
- 相对`0810_08`标准warmup12+cosine同点，cls/det HOTA提高`4.554/5.016`，
  cls DetA/AssA提高`2.184/7.870`，det提高`3.040/8.163`；pair mAP/AP50提高
  `0.033569/0.037949`，both-independent提高`0.028767/0.022960`。缩短warmup的形成优势
  从e4保持到e8，但物理1x8与旧2x4存在拓扑差异，且e8仍非成熟否决点，继续e12及后续节点。
...
- 178 One-Cycle e72 为 cls HOTA/DetA/AssA `54.162/44.589/68.101`、det
  `62.280/54.464/73.498`，sum `116.442`；距目标 `1.101/0.319/1.420`，严格失败。
  pair `0.310752/0.512149`、both-independent `0.347665/0.545261`。checkpoint
  SHA `5b499149…353a`，meta `72/74736`，2,776 浮点 tensor 全有限，
  5416/50、51/28/108/50 与 async=1 全闭环；训练自然退出，GPU0 释放。
- 99 cosine e68 为 cls `54.387/45.032/67.653`、det `62.298/54.093/74.181`，
  sum `116.685`；较 e64 `+0.033/+0.099/+0.132`，但四项 AP 继续下降，e52
  保持总榜最佳。checkpoint SHA `d55951a2…0f22b`，meta `68/70584`，完整闭环并继续 e72。
- 252 WSD e36 为 cls `52.478/43.485/65.096`、det `60.531/52.523/72.206`，
  sum `113.009`；较 e32 `+0.088/+0.268/+0.356`，det DetA/AssA 与四项 AP 全升。
  checkpoint SHA `b4a5c835…1cde7`，meta `36/37368`，完整闭环并继续 e40/e72。
- 实时 99 e69i600、252 e38i500，fatal=0；178 GPU0 空闲，GPU1 外部任务不动，下一步
  动态验证标准 warmup4-cosine `1x8` 后备。

## 2026-08-11 14:21 CST：99 e64、178 e68 完整闭环

- 99 cosine e64 为 cls HOTA/DetA/AssA `54.354/45.147/67.310`、det
  `62.199/54.099/73.952`，sum `116.553`；较 e60 `+0.117/-0.107/+0.010`，
  det AssA 下降且四项 AP 全降，e52 保持总榜最佳。pair `0.310301/0.528114`、
  both-independent `0.349620/0.565467`。checkpoint SHA `6aebf315…54e6`，meta
  `64/66432`，2,776 浮点 tensor 全有限，5416/50、51/28/108/50 与 async=1 全闭环。
- 178 One-Cycle e68 为 cls `54.458/44.857/68.459`、det
  `62.218/54.543/73.239`，sum `116.676`；较 e64 `+0.047/+0.024/+0.071`，但
  四项 AP 继续下降且仍低 e60 `0.163/0.114/0.277`。pair `0.311871/0.514154`、
  both-independent `0.349024/0.547445`。checkpoint SHA `35048e05…807a`，meta
  `68/70584`，2,776 浮点 tensor 全有限，检测与 TrackEval 全闭环。
- 两条快线继续到 e72，不用尾段回落提前替代目标判定。实时 99 e65i500、178 e69i300、
  252 e35i50，fatal=0；下一节点优先为 252 WSD e36。
...
- 178 One-Cycle e60 为 cls HOTA/DetA/AssA `54.621/44.980/68.713`、det
  `62.332/54.702/73.262`，sum `116.953`；较 e56 为 `+0.255/-0.086/+0.169`，
  距目标 `0.642/0.267/0.909`。pair `0.313151/0.517305`、both-independent
  `0.351281/0.552379`。checkpoint SHA `fea200a4…9c43d`，meta `60/62280`，
  2,776 浮点 tensor 全有限，5416/50、51/28/108/50 与 async=1 全闭环。
- 99 cosine e56 为 cls `54.544/45.292/67.421`、det `62.238/54.082/74.102`，
  sum `116.782`；较 e52 为 `-0.265/+0.072/-0.193`，cls 与四项 AP 回撤，故 e52
  仍为本线和当前总榜最佳。checkpoint SHA `30cd7a6d…8293b`，meta `56/58128`，
  2,776 浮点 tensor 全有限，检测与 TrackEval 全闭环。
- 252 WSD e28 为 cls `52.190/43.179/65.336`、det `59.526/51.978/70.593`，
  sum `111.716`；较 e24 HOTA `+1.056/+0.834`，DetA、AssA 与四项 AP 全升至 pair
  `0.290251/0.491216`、both-independent `0.333728/0.537733`。checkpoint SHA
  `5b880aa0…25d56`，meta `28/29064`，2,776 浮点 tensor 全有限，5416/50、
  51/28/108/50 与 async=1 全闭环。
- 当前最高仍为 99 e52 `116.975`，只高 178 e60 `0.022`。实时 99 e59i750、
  178 e64i50、252 e29i950，fatal=0；下一节点 e60/e64/e32。

## 2026-08-11 11:00 CST：99 e52、178 e56、252 e24 完整闭环

- 99 cosine e52 为 cls HOTA/DetA/AssA `54.809/45.499/67.928`、det
  `62.166/54.053/74.001`，sum `116.975`；较 e48 为 `-0.007/+0.190/+0.183`，
  距目标 `0.454/0.433/0.887`。pair mAP/AP50 `0.315777/0.540024`、
  both-independent `0.354497/0.575993`。checkpoint SHA `64ce252a…81204`，meta
  `52/53976`，2,776 浮点 tensor 全有限，5416/50、51/28/108/50 与 async=1 全闭环。
- 178 One-Cycle e56 为 cls `54.366/44.868/68.092`、det
  `62.418/54.731/73.378`，sum `116.784`；较 e52 双升 `0.137/0.207`，刷新本线最佳，
  距目标 `0.897/0.181/1.078`。checkpoint SHA `ed2dad52…64743`，meta `56/58128`，
  2,776 浮点 tensor 全有限，检测与 TrackEval 全闭环。GPU1 为外部 InternVL。
- 252 WSD e24 为 cls `51.134/42.708/63.556`、det `58.692/51.630/69.052`，
  sum `109.826`；较 e20 HOTA `+1.961/+1.314`，DetA、AssA 和四项 AP 全升至 pair
  `0.286376/0.486337`、both-independent `0.330717/0.534863`。checkpoint SHA
  `e812198a…0cb45`，meta `24/24912`，2,776 浮点 tensor 全有限，5416/50、
  51/28/108/50 与 async=1 全闭环。
- 当前最高为 99 e52；其相对 178 e56 的 cls/det/sum 为
  `+0.443/-0.252/+0.191`，无全面支配。实时 99 e54i850、178 e59i250、252 e25i800，
  fatal=0；99 GPU1 是外部 UNet，PairMOT 仅 GPU0/2。下一节点 e56/e60/e28。

## 2026-08-11 09:20 CST：99 e48、178 e52、252 e20 完整闭环

- 99 cosine e48 为 cls HOTA/DetA/AssA `54.816/45.630/67.843`、det
  `61.976/54.023/73.606`，sum `116.792`；较 e44 HOTA `+0.224/+0.148`，主要由
  AssA `+1.079/+0.309` 推动。pair mAP/AP50 `0.316895/0.542803`、
  both-independent `0.356673/0.580762`，距目标 `0.447/0.623/1.070`。
  checkpoint SHA-256 `d6458f01…86420`，meta `48/49824`，2,776 浮点 tensor 全有限，
  5416/50、51 检测文件、28 CSV/108 非空/50 predictions、async=1 全闭环。
- 178 One-Cycle e52 为 cls `54.229/44.901/67.790`、det
  `62.211/54.708/72.964`，sum `116.440`；较 e48 为 `-0.184/+0.035/-0.149`，
  cls 与四项 AP 回撤，因此 e48 仍是本线最佳，继续 e56/e72。checkpoint SHA-256
  `f81cba11…b78282`，meta `52/53976`，2,776 浮点 tensor 全有限，检测与 TrackEval
  全闭环。GPU1 的约 4.3 GiB 负载经 PID/命令行核验为其他用户 InternVL，PairMOT 仅 GPU0。
- 252 WSD e20 为 cls `49.173/40.431/62.890`、det `57.378/50.079/67.979`，
  sum `106.551`；较 e16 HOTA `+0.264/+0.553`、AssA `+1.091/+1.316`，四项 AP
  全升至 pair `0.269620/0.460271`、both-independent `0.311399/0.506833`。
  checkpoint SHA-256 `b4d41f48…381339`，meta `20/20760`，2,776 浮点 tensor 全有限，
  5416/50、51/28/108/50 与 async=1 全闭环。
- 当前最高为 99 e48；99 e48 相对 178 e52 的 cls/det/sum 为
  `+0.587/-0.235/+0.352`，无全面支配。实时 99 e49i500、178 e53i950、252 e21i400，
  fatal=0；下一节点 e52/e56/e24。197 未部署，静态后备不占卡。

## 2026-08-11 08:05 CST：99 e44、178 e48、252 e16 完整闭环

- 178 One-Cycle e48 为 cls HOTA/DetA/AssA `54.413/45.115/67.809`、det
  `62.176/54.585/73.086`，sum `116.589`；较 e44 双升 `0.117/0.371`，关联增强但
  AP 小幅回落。pair mAP/AP50 `0.313493/0.522858`、both-independent
  `0.353039/0.560230`，距目标 `0.850/0.423/1.273`。checkpoint SHA-256
  `6bde0c15…0a131`，meta `48/49824`，2,776 浮点 tensor 全有限，5416/50、
  51 检测文件、28 CSV/108 非空/50 predictions、async=1 全闭环。
- 99 cosine e44 为 cls `54.592/45.838/66.764`、det `61.828/53.997/73.297`，
  sum `116.420`；较 e40 双升 `0.051/0.117`，DetA 和四项 AP 上升，AssA 微回撤。
  pair `0.315990/0.544399`、both-independent `0.356856/0.584397`，距目标
  `0.671/0.771/1.442`。checkpoint SHA-256 `23d80dac…ea77`，meta `44/45672`，
  2,776 浮点 tensor 全有限，检测与 TrackEval 全闭环。
- 252 WSD e16 为 cls `48.909/40.235/61.799`、det `56.825/50.063/66.663`，
  sum `105.734`；较 e12 HOTA `+3.070/+3.627`，DetA、AssA 与四项 AP 全升。
  checkpoint SHA-256 `872afb3d…1b160`，meta `16/16608`，2,776 浮点 tensor 全有限，
  检测与 TrackEval 全闭环。
- 178 e48 相对 99 e44 的 cls/det/sum 为 `-0.179/+0.348/+0.169`，没有全面支配；
  两条均继续。当前 99 e45i350、178 e49i850、252 e17i800，fatal=0；197 仍超时，
  未部署、未占卡。下一完整节点为 e48/e52/e20。

## 2026-08-11 06:55 CST：99 控制入口纠正与三线资源复核

- 99 正确 SSH 入口为端口 `2367`；端口 22 超时不代表主机不可达。通过正确入口已直接确认
  formal screen、torchrun/worker 和动态 GPU0/2 存活，GPU1 仅 10 MiB、未触碰；正式日志
  到 e41i750 且数值有限。178 到 e46i200、仅 GPU0，252 到 e14i650、仅固定 GPU0/1；
  三线 fatal=0。197 使用正确身份探测仍超时，故不部署、不占卡。

## 2026-08-11 06:50 CST：99 e40、178 e44、252 e12 完整闭环

- 99 warmup12-cosine e40 为 cls HOTA/DetA/AssA `54.541/45.648/66.996`、det
  `61.711/53.800/73.328`，sum `116.252`；pair mAP/AP50 `0.313022/0.541495`，
  both-independent `0.354448/0.583415`。较 e36 HOTA `+1.633/+0.829` 且六项
  DetA/AssA、四项 AP 全升，距目标 `0.722/0.888/1.610`。419,439,798-byte checkpoint
  SHA-256 `d417c380…e75fe`，2,776 浮点 tensor 全有限，5416/50、28/108/50 与 async
  全闭环，成为当前最强成熟点。
- 178 One-Cycle e44 为 cls `54.296/45.257/67.308`、det
  `61.805/54.445/72.434`，sum `116.101`；pair `0.315597/0.530427`，
  both-independent `0.355256/0.568277`。较 e40 HOTA `+0.294/+0.036`、DetA
  `+0.472/+0.372`、AssA 小幅回撤，四项 AP 全升；距目标 `0.967/0.794/1.761`。
  425,217,396-byte checkpoint SHA-256 `b9e93b47…363e8`，有限性、检测和 TrackEval
  全闭环。99 e40 比 178 e44 的 cls/det/sum 为 `+0.245/-0.094/+0.151`，无全面支配。
- 252 WSD e12 为 cls `45.839/37.744/58.033`、det `53.198/47.726/61.322`，sum
  ...
  较 e8 HOTA `+2.698/+4.643`，DetA、AssA 与 AP 全升。380,977,590-byte checkpoint
  SHA-256 `be2a1a73…7479`，2,776 浮点 tensor 全有限，5416/50、28/108/50 与 async
  全闭环；仍属稳定段早期，继续 e16/e72。
- 当前 99 e41i300、178 e45i950、252 e14i350；当时 99 端口 22 与 197 SSH 超时，但 99 共享盘
  正式日志持续更新，197 未部署、未占卡。下一节点为 e44/e48/e16。

## 2026-08-11 05:30 CST：178 e40、99 e36、252 e8 完整闭环

- 178 One-Cycle e40 为 cls HOTA/DetA/AssA `54.002/44.785/67.444`、det
  `61.769/54.073/72.894`，sum `115.771`；pair mAP/AP50 `0.311467/0.526878`，
  both-independent `0.352117/0.566599`。相对 e36 的 HOTA、DetA、AssA、AP 全升，
  距目标 cls/det/sum `1.261/0.830/2.091`。419,711,476-byte checkpoint SHA-256
  `aa15d33e…7a555`，2,776 浮点 tensor 全有限，5416/50、28/108/50 与 async 全闭环。
- 99 cosine e36 为 cls `52.908/43.934/65.701`、det `60.882/52.685/72.901`，sum
  `113.790`；pair `0.301377/0.523105`，both-independent `0.341658/0.564110`。
  HOTA 较 e32 双升；413,966,518-byte checkpoint SHA-256 `a3d5bdf0…a1ee3`，有限性、
  检测与 TrackEval 全闭环。同 e36 比 One-Cycle 总和高 `0.195` 但 det 低 `0.355`，无全面支配。
- 252 WSD e8 为 cls `43.141/35.571/55.097`、det `48.555/43.935/55.606`，sum
  `91.696`；pair `0.217427/0.377477`，both-independent `0.260923/0.435138`。
  相对 e4 HOTA `+11.037/+8.549` 且 DetA/AssA/AP 全升；375,508,598-byte checkpoint
  SHA-256 `b304c684…fd694a`，有限性和 5416/50、28/108/50 全闭环。不得以 e8 停线。
- 当前 99 e37i300、178 e41i850、252 e10i1000，继续 e40/e44/e12 及 e72；197 不可达，
  未部署、未占卡。

## 2026-08-11 04:14 CST：99 e32、178 e36 完整闭环

- 99 warmup12-cosine e32 为 cls HOTA/DetA/AssA `52.597/44.088/64.394`、det
  `60.315/52.364/71.924`，sum `112.912`；pair mAP/AP50 `0.297949/0.520409`，
  both-independent `0.339567/0.564152`。相对 e28 的 HOTA、DetA、AssA 与四项 AP 全升。
  408,479,606-byte checkpoint SHA-256 `e576146b…7b71a`，2,776 浮点 tensor 全有限，
  5416/50、28/108/50 与 async 全闭环。
- 178 ratio-preserving One-Cycle peak×2.5 e36 为 cls `52.358/43.136/65.967`、det
  `61.237/53.498/72.511`，sum `113.595`；pair `0.302935/0.513138`，
  both-independent `0.343896/0.554494`。相对 e32 的 cls/det HOTA
  `+0.919/+0.387`，六项 DetA/AssA 与四项 AP 全升。414,205,108-byte checkpoint
  SHA-256 `4a7612ae…81b10`，有限性、检测和 TrackEval 全闭环。
- 同 e32，99 领先 cls、sum 与 AP，178 领先 det 与 AssA，没有全面支配；两线继续 e36/e40
  和 e72。当前进度 99 e33i350、178 e37i850、252 e7i550；197 又一次只读连接超时，
  未部署、未占卡。

## 2026-08-11 03:37 CST：99 e28、178 e32、252 e4 完整闭环

- 99 `0810_08` e28 为 cls HOTA/DetA/AssA `51.974/43.872/63.535`、det
  `59.718/52.118/70.892`，sum `111.692`；pair mAP/AP50 `0.296164/0.517461`，
  both-independent `0.338926/0.563368`。相对 e24 HOTA `+0.124/+0.719`，四项 AP
  全升。402,992,438-byte checkpoint SHA-256 `7bfe550b…a7841`，浮点 tensor 全有限，
  5416/50、28 CSV/108 非空文件/50 predictions 与 async 全闭环。
- 178 `0810_06` e32 为 cls `51.439/42.464/64.809`、det
  `60.850/52.938/72.392`，sum `112.289`；pair `0.295390/0.500819`，
  both-independent `0.336153/0.542595`。相对 e28 HOTA `+0.126/+0.607`，det
  DetA/AssA `+0.362/+0.983`。408,691,956-byte checkpoint SHA-256
  `d296519e…92a3e`，有限性、检测与 TrackEval 全闭环。
- 同 e28，99 的 cls/sum 与 AP 更高，178 的 det/AssA 更高，没有全面支配；两者继续 e32/e36
  及 e72。实时训练为 99 e31i350、178 e36i50，正式日志、GPU 与有限性健康。
- 252 WSD e4 为 cls HOTA/DetA/AssA `32.104/24.149/46.108`、det
  `40.006/31.048/52.422`，sum `72.110`；pair `0.125499/0.234166`、both-independent
  `0.167094/0.302948`。369,969,206-byte checkpoint SHA-256 `bb7633ca…e556c`，
  2,776 浮点 tensor 全有限，5416/50、28/108/50 与 async 全闭环；训练到 e5i750。
  该点只验证四轮标准 warmup 的可训练性，不得用 e4 否决，继续 e8/e72。197 再次只读 SSH
  超时，未部署、未占卡。
...
- 178 `0810_06` e28 完整结果为 cls HOTA/DetA/AssA `51.313/42.205/64.926`、det
  `60.243/52.576/71.409`，sum `111.556`；pair mAP/AP50 `0.292999/0.500325`，
  both-independent `0.333631/0.542761`。403,176,116-byte checkpoint SHA-256
  `fe99173216c65067912d3979fe8a426ad014944c9bbe8b39f8d86d05f4de0806`，642 tensor、
  iterative-cls/DN、5416/50、28 CSV/108 非空文件/50 predictions 完整；训练到 e30i1000，
  单卡 GPU0、fatal=0，继续 e32/e72。
- 99 `0810_08` e24 为 cls `51.850/43.920/62.866`、det `58.999/51.742/69.628`，
  sum `110.849`；pair `0.293353/0.508800`，both-independent `0.337096/0.558036`。
  397,499,574-byte checkpoint SHA-256
  `c887c28c0c8609cc3e324465a1df498de37f9f65a9dd453c55e95d05f9e9c1ee`，完整闭环；
  相对 e20 的 HOTA、DetA、AssA 与四项 AP 全升。训练到 e26i400，动态 GPU0/2、fatal=0。
- 252 `0810_07` e24 为 cls `48.913/40.141/61.988`、det `55.278/49.174/64.653`，
  sum `104.191`；pair `0.259727/0.455464`，both-independent `0.301252/0.505747`。
  397,539,638-byte checkpoint SHA-256
  `cb74956db753eeb3047eca9adf0d35bea2933847fc8a0c854b36a39cd4972d4b` 且 5416/50、
  28/108/50 全闭环。该峰后成熟点被 178 同 e24 的 HOTA、DetA、AssA、AP 全面支配，故在
  e25i1000 精确停止并释放固定 GPU0/1；不是依据 e4/e8 停线。
- 随后在 252 独立 clean checkout 部署标准 WSD `0810_09`（commit `34efcf4`）：4 epoch
  线性 warmup 到 `1.5×`、56 stable、12 cosine。配置 deepcopy、两个 launcher Bash 语法、
  父/候选完整构建均通过，均为 22,771,111 参数/711 states；实际 497 optimizer groups 保持
  `[0.1,1,2,20]` 倍率。模型、数据语义、loss、EMA、global batch 和推理图未变。
- 固定 GPU0/1 的真实 4-iter DDP smoke 四个 loss/grad 全有限；364,512,758-byte checkpoint
  SHA-256 `e38b5e39287711d4e4ae9db27427596e21f2fde8a253016a6485e6922569b897`，
  iterative-cls/DN 已训练、642 浮点 tensor 全有限、fatal=0。fresh formal 的 screen/torchrun、
  双 rank、GPU0/1、工作目录均一致，e1 iter50 LR/loss/grad
  `1.0e-7/21.5442/108.2206`，total、DN、encoder proposal 全有限且 fatal=0；五项门槛后登记
  `RUNNING/TO_E72`。
...
- 252 One-Cycle peak×2.0 e20 为 `46.929/52.657`，DetA/AssA
  `38.174/60.025` 与 `46.889/61.566`，pair `0.242264/0.426941`，both-independent
  `0.283642/0.478540`；相对 e16 全指标继续改善，但同 e20 被 178 peak×2.5 全面领先，
  保留至峰后 e24。checkpoint SHA `195d8057…a0bb`，完整闭环，TrackEval 977.9 秒，训练到
  e21 iter800。
- 178 One-Cycle peak×2.5 e24 为 `51.080/59.275`，DetA/AssA
  `42.101/64.283` 与 `51.994/69.864`，pair `0.295309/0.503612`，both-independent
  `0.336887/0.547816`；相对 e20 的 HOTA、DetA、AssA 与 AP 全升，无峰后过冲。checkpoint
  SHA `15cef14d…ab04`，完整闭环，训练恢复 e25 iter300。
- 99 warmup12-cosine e20 为 `51.228/58.036`，DetA/AssA
  `43.034/62.808` 与 `51.044/68.380`，pair `0.288417/0.500151`，both-independent
  `0.331713/0.549963`；同 e20 HOTA 高 178 `1.289/0.273`，但 mAP 略低；相对 178 e24
  cls `+0.148`、det `-1.239`，支持真实前移但未达到四 epoch 全量等价，继续 e24。checkpoint
  SHA `0e31ae5f…f4d0`，完整闭环，训练恢复 e21 iter300。

## 2026-08-10 23:05 CST：178 e20 与 99 e16 完整闭环

- 178 One-Cycle peak×2.5 e20 为 cls/det `49.939/57.763`，DetA/AssA
  `41.658/62.407` 与 `51.299/67.177`，pair `0.291977/0.491287`，both-independent
  `0.335227/0.539099`；相对 e16 HOTA 双升 `0.933/2.761`，DetA、AssA、AP 全升。
- 178 checkpoint SHA `87b08174…2a27`，642 tensor、iterative-cls/DN、5416/50、
  28/108/50 与 async 全闭环；TrackEval 268.4 秒，训练恢复 e21 iter300，继续峰后 e24。
- 99 warmup12-cosine e16 为 `49.327/56.697`，DetA/AssA `41.727/60.321` 与
  `50.140/66.435`，pair `0.276969/0.480504`，both-independent
  `0.320977/0.533255`；相对 e12 双升 `2.575/3.492`，同 e16 高 178
  `0.321/1.695`，且只低 178 e20 `0.612/1.066`，支持约四 epoch 成熟前移。
- 99 checkpoint SHA `126c020a…be88`，完整性与异步闭环全通过，TrackEval 307.7 秒，
  训练恢复 e17 iter300；继续 e20/e24 验证 warmup-cosine 优势能否保持。

## 2026-08-10 22:37 CST：252 One-Cycle peak×2.0 e16 完整闭环

- 252 e16 为 cls/det `45.071/50.068`，DetA/AssA `36.674/57.882` 与
  `44.936/57.857`，pair `0.227497/0.402997`，both-independent
  `0.270990/0.460384`；相对 e12 HOTA 继续双升 `6.025/6.100`，所有 DetA/AssA/AP
  同步改善。
- checkpoint SHA `c828c6b6…1884`，642 个浮点 tensor 与 iterative-cls/DN 有限且已训练；
  5416/50、28/108/50、`async_done=1` 全闭环。TrackEval 因 NFS 等待耗时 991.9 秒后
  自然恢复，主训练已到 e17 iter900。
- 同 e16 被 178 peak×2.5 在 HOTA、DetA、AssA、AP 全面领先，但两条路线均在
  epoch21.6 达峰，故继续 252 到 e20/e24，不以 e16 直接停线。
...
- 178 One-Cycle peak×2.5 e12 为 cls/det `44.024/49.377`，DetA/AssA
  `37.766/54.705` 与 `46.686/53.771`，pair `0.242287/0.418168`，
  both-independent `0.290527/0.480515`；checkpoint SHA `3b6dc39a…fd1`，完整性门槛
  全通过，训练恢复到 e15 iter750。
- 99 warmup-cosine e8 为 `40.201/46.708`，DetA/AssA `33.203/51.170` 与
  `41.073/55.034`，pair `0.196932/0.351540`，both-independent
  `0.239690/0.412321`；checkpoint SHA `3534d07f…04b`，完整闭环，训练到 e10 iter1000。
- 252 One-Cycle peak×2.0 e12 为 `39.046/43.968`，DetA/AssA
  `32.850/48.962` 与 `40.484/48.999`，pair `0.187661/0.341973`，
  both-independent `0.237962/0.419204`；checkpoint SHA `e65260a3…877d`，完整闭环。
  TrackEval 因共享存储 RPC 等待耗时 916.5 秒后自然恢复完成，训练已到 e13 iter800。
- 99 形成最快、178 peak×2.5 同 e12 全面优于 252 peak×2.0；两条 One-Cycle 均继续至
  e16 与 epoch21.6 后成熟节点，99 继续 e12。三点均不作为最终 e72 否决。
...
- 99 `0810_08` e4 cls HOTA/DetA/AssA `27.170/20.136/39.522`，det
  `36.995/28.502/48.859`；pair mAP/AP50 `0.090551/0.186640`，both-independent
  `0.126042/0.249651`。369,988,342-byte checkpoint SHA-256 为 `815f8d84…e5115`；
  5416/50、28/108/50 与有限性完整，TrackEval 223.2 秒，训练恢复 e5 iter550。
- 252 `0810_07` e8 cls `31.712/24.229/44.724`，det
  `37.834/31.449/46.794`；pair `0.115459/0.222711`，both-independent
  `0.157338/0.294269`。375,593,718-byte checkpoint SHA-256 为 `9e82d591…e420d`；
  5416/50、28/108/50 与有限性完整，TrackEval 331.2 秒，训练恢复 e9 iter300。
- 99 e4 比同为 2×4 的 252 e4 HOTA 高 `12.296/5.581`，显示 warmup-cosine 形成更快；
  252 e8 相对 178 e8 更偏高 AssA、低 DetA/AP。两者均为诊断，不以 e4/e8 否决。
...
- commit `18f7465` 在全新隔离 checkout 中实现标准 warmup-stable-decay：4 epoch 线性
  warmup 至 `1.5×` 父线 LR，56 epoch stable，最后 12 epoch cosine decay；连续名义 LR
  积分为 96 个父线 epoch，真实 MMEngine 离散序列积分为 `96.752825`。
- 候选与父线的 model、data、loss、EMA、global batch、hooks 和推理图相同。远端配置
  deepcopy、launcher 语法、父/候选完整构建均通过，均为 `22,771,111` 参数/711 states；
  实际 497 optimizer groups 保持 `[0.1,1,2,20]` 倍率。
- 当前 GPU0/2 属于存活 `0810_08`，GPU1 为外部任务，因此没有创建 smoke/formal workdir，
  没有占用 GPU，状态仅为 `STATIC_VALIDATED/NO_SMOKE/NO_FORMAL`。后续必须重新动态选取两张
  空闲卡并通过 smoke、checkpoint 和 formal iter50 五门槛。
- commit `a914606` 已补齐 197 同候选的 host-only 配置与 launcher；本地 Python/Bash 语法
  通过。由于 197 继续 SSH 超时，它尚未同步、远端 deepcopy/构建或创建任何 workdir，故只记
  `LOCAL_PREPARED/HOST_UNREACHABLE/NO_SMOKE/NO_FORMAL`，不能替代 99 的远端静态证据。
...
## 2026-08-10 02:31 CST：178 `0810_02` EMA-lag 评测启动

- 252 `0808_08` e72 原点距 det/保底 sum 分别只差 `0.121/0.764`。`0810_02` 不重训，
  仅将同一 checkpoint 的 EMA 权重向同一步 online 权重插值 `0.25/0.50`，无参数量、模型图、
  class-aware、reweight 或推理 FLOPs 变化。
- 178 隔离 checkout `5e007da` 已验证来源/评测 model dict 相等；两个 711-state payload
...
## 2026-08-10 03:12 CST：178 `0810_03` 完整失败并释放资源

- decoder-frozen 0.25 校正的 cls HOTA/DetA/AssA 为 `54.810/45.577/67.327`，det 为
  `62.340/54.317/73.902`，sum `117.150`；pair `0.319153/0.540030`、
  both-independent `0.359617/0.577048`，5416/50、28/108/50 全量闭环。
- 严格 margin `+0.373/-0.053/-0.680`、verifier rc=2。相对全模型 0.25，DetA 与 AssA
...
## 2026-08-09 02:30 CST：197 e28 与 178 e4 完整闭环

- 197 分阶段全局 LR e28 为 `52.580/58.980`、sum `111.560`，相对直接父线同点仅低
  `0.061/0.006`，但低旧局部 decoder/head LR 同点 `0.270/0.722`；DetA 略高而 AssA 与
  四项 AP 偏低，说明第二阶段目前只复现父线，尚无成熟提前量。checkpoint 有限性、
  5416/50、28/108/50 和异步 TrackEval 均闭环，训练恢复 e30；继续 e32 后再作成熟换线。
- 178 局部延迟 LR e4 为 `32.955/41.857`、sum `74.812`，该点完全位于 e12 LR 切换前，
  只记录诊断而不否决。369,986,740-byte checkpoint SHA-256 为
  `4a2e195c8de24a9943c1d14f6a1c5e651952856ce09ac6e0f6bf004980684ef5`，642 个浮点
  model/EMA 张量全有限；检测/TrackEval 完整，训练恢复 e5，只用 GPU0。
- 252 e8 checkpoint 与 5416/50 检测已完成，异步 TrackEval 仍在运行；正式训练已恢复 e9，
  严格只用固定 GPU0/1。99 已进入 e28 训练；在两者闭环前不做无证据换线。

## 2026-08-09 02:34 CST：252 e8 TrackEval 闭环并继续成熟窗口

- 局部 Adam 时钟 e8 cls/det 为 `40.166/47.240`，DetA/AssA 为
  `33.358/50.568` 与 `42.304/54.498`；较 e4 双升 `9.060/9.933`，但相对直接父线同点低
  `6.507/6.682`，pair 与 both-independent AP 也一致偏低。它仍是负的早期诊断，不能作为
  e8 停线依据，继续到 e12/e16。
- checkpoint 375,537,462 bytes、SHA-256
  `2c9d29b07be111012bc3648e9708cdb7308a70818fe2d3aeb73978be403e54ed`；meta
  `8/8304`，model/EMA 各 642 个浮点张量全有限。5416/50、28/108/50 与异步完成证据完整，
  TrackEval 361.0 秒；formal 恢复 e9i350，只用固定 GPU0/1，GPU2/3 空闲。

## 2026-08-09 02:59 CST：99 成熟换线与 `0809_02` formal 五门槛

- `0808_06` e28 为 `50.334/59.149`、sum `109.483`；相对 e24 只升 `0.286/0.480`，
  同点低 197 总和 `2.415`、低直接父线总和 `2.144`，且 cls、DetA 与四项 AP 被成熟支配。
  e20/e24/e28 三个切换后节点、checkpoint 有限性、5416/50、28/108/50 和异步 TrackEval
  完整后，原 PGID `2606266` 于 e29i350 精确停止；成员连续两次为 0，GPU0/1 释放。
- `0809_02` 真实双卡 smoke 四步 loss/grad 全有限；364,517,174-byte checkpoint SHA-256
  `0ace5d744d4e1c365f5609c8273c6f7c271cc0ffb12734f6913d27a81401a1a8`，642 浮点
...
## 2026-08-09 03:42 CST：178 e8 完整闭环并继续核心窗口

- 178 局部延迟 LR e8 为 `42.853/49.918`、sum `92.771`；较自身 e4 双升
  `9.898/8.061`，并比 252 局部 Adam 时钟同点高 `2.687/2.678`，四项 AP 也全高。
  相对直接父线仍低 `3.820/4.004`，但 e12 局部 LR 尚未触发，因此只作诊断、不停线。
- checkpoint 375,582,388 bytes、SHA-256
  `5e3296522e332a37d8d1d70fc99938beeed33c51a90eb80004b93a081c6eefed`；642 浮点
  张量有限、iterative-cls/DN 已训练，5416/50、28/108/50 完整，TrackEval 240.5 秒。
  formal 恢复 e9i350，只用 GPU0；继续 e12/e16。

## 2026-08-09 03:59 CST：252 e12 成熟偏弱但保留至 e16 复核

- 252 局部 Adam 时钟 e12 为 `45.569/52.337`，较 e8 双升 `5.403/5.097`，但低直接父线
  `4.215/3.906`、低旧局部 LR `2.429/2.826`；双 DetA/AssA 与四项 AP 也均未形成补偿。
  这是 e4/e8/e12 的一致负轨迹，但 e8→e12 仍明显恢复，故按预定成熟约束继续 e16 后复核，
  不是用 e4/e8 或单个 e12 停线。
- checkpoint 381,036,022 bytes、SHA-256
  `ec1bb0a7b5b35e14f62de6c4e8978a29fd561e4aa6c99578f5c32ba4035a2e2d`；642 浮点
  张量有限、iterative-cls/DN 已训练，5416/50、28/108/50 完整，TrackEval 453.1 秒。
  formal 恢复 e13i450，只用固定 GPU0/1，GPU2/3 空闲。
## 2026-08-13 02:43 CST：成熟学习率四线实时审计

- 99 `0812_03` 到e24i600（GPU0/2），178 `0812_04`到e24i50（GPU0），197 `0813_01`
  到e4i250（GPU4/5），252 `0812_05`到e9i850（固定GPU0/1）；四线进程、GPU和正式日志
  均在更新，关键训练数值有限。AutoDL保持关机，不产生收费空转。
- 252 e8完整结果为cls/det `43.884/49.589`、sum `93.473`；DetA/AssA分别为
  `35.883/56.462`与`43.648/58.374`，pair/both mAP为`0.2181/0.2613`。相对178同调度
  e8低`4.146/4.650`且各证据一致偏低，但该点只作早期物理拓扑诊断，不以e8否决，继续e12+。
## 2026-08-13 02:59 CST：99 floor-cosine e24闭环

- `0812_03` e24 cls HOTA/DetA/AssA `52.748/44.199/64.972`，det
  `59.179/52.068/69.589`，sum `111.927`；pair mAP/AP50 `0.2926/0.5016`，
  both-independent `0.3363/0.5498`。较e20双升`0.757/0.347`，仍继续到成熟尾段。
- e24 checkpoint `397,531,126` bytes，5416/50检测、28 CSV、108非空评测文件、50预测和
  async完成标志齐全；训练恢复e25i300。同期178 e24i800、197 e4 checkpoint已生成、252 e10i500。
