...
| 178 | `0803_09 log-size tangent + periodic-angle` | RUNNING/TO_E24；e20 `49.781/57.217`，相对原始 decoder 同点 `-1.062/-0.816`；PGID `2971994` | `0803_13 terminal geometry` PREPARED | `/data4/litianhao/PairMmot/workdir_178` |
